...
public class CMessage_test {
    ...
    private String _sendMobile ;
    private String _sendMessage ;
    private String _sendTime ;
    private String _sendResult ;
    private String _sendMemo="" ;
    ...
    public static final int sendId = 14;
    public static final int sendType = 15;
    public static final int sendMode = 16;
    public static final int sender = 17;
    public static final int sendTo = 18;
    public static final int sendMobile = 19;
    public static final int sendMessage = 20;
    public static final int sendTime = 21;
    public static final int sendResult = 22;
    public static final int sendMemo = 23;

    private CMessage_test() {
        _msgId = ""; //消息id
        _msgTitle = ""; //消息标题
        _msgContent = ""; //消息内容
        _msgIsNew = "1"; //是否为新消息
        ...
        _sendResult = "0";
        _sendMemo = "";
        this._sendTime = new CDate().getNowTime();
        this._msgSendTime = new CDate().getNowTime(); //默认是当前时间发送
    }

    public CMessage_test(CDataImpl dImpl) {
        this();
        this._dImpl = dImpl;
    }
     ...
     * @param msgId  消息id
     */
    public CMessage_test(CDataImpl dImpl, String msgId,String sendId) {
        this(dImpl);
        ...
        String sql_send = "select * from sendmsgtable where send_id='" + sendId + "'";
        Hashtable cont_send = _dImpl.getDataInfo(sql_send);
        if (cont_send != null) {
            this._sendId = cont_send.get("send_id").toString();
            this._sendType = cont_send.get("sendtype").toString();
            this._sendMode = cont_send.get("sendmode").toString();
            this._sender = cont_send.get("sender").toString();
            this._sendTo = cont_send.get("sendto").toString();
            this._sendMobile = cont_send.get("sendmobile").toString();
            this._sendMessage = cont_send.get("sendmessage").toString();
            this._sendTime = cont_send.get("sendtime").toString();
            this._sendResult = cont_send.get("sendresult").toString();
            this._sendMemo = cont_send.get("sendmemo").toString();
            this._sendTime = _sendTime.substring(0,_sendTime.length()-2);
        }
    }
     ...
     * @return 返回新记录的id
     */
    public String addNew1() {
        this._msgId = this._dImpl.addNew("tb_message", "ma_id",
                                         CDataImpl.PRIMARY_KEY_IS_VARCHAR);
        return this._msgId;
    }

    public String addNew2(){
        this._sendId = this._dImpl.addNew("sendmsgtable","send_id",CDataImpl.PRIMARY_KEY_IS_VARCHAR);
        return this._sendId;
    }
    ...
    public void update2() {
     this._dImpl.setValue("sendtype",_sendType,CDataImpl.STRING);
     this._dImpl.setValue("sendmode",_sendMode,CDataImpl.STRING);
     this._dImpl.setValue("sender",_sender,CDataImpl.STRING);
     this._dImpl.setValue("sendto",_sendTo,CDataImpl.STRING);
     this._dImpl.setValue("sendmobile",_sendMobile,CDataImpl.STRING);
     this._dImpl.setValue("sendmessage",_sendMessage,CDataImpl.STRING);
     this._dImpl.setValue("sendtime",_sendTime,CDataImpl.STRING);
     this._dImpl.setValue("sendresult",_sendResult,CDataImpl.STRING);
     this._dImpl.setValue("sendmemo",_sendMemo,CDataImpl.STRING);
     this._dImpl.update();
    }

    public void update1(int fieldName, String val) {
        if (!_msgId.equals("")) {
    ...
    public void update2(int fieldName,String val){
        if (!_sendId.equals("")){
            this._dImpl.edit("sendmsgtable","send_id",_sendId);
            setValue(fieldName, val);
            update2();
        }
        else {
    ...
    public String getValue(int fieldName) {
        ...
        switch (fieldName) {
            ...
            case sendId:
                ...
                break;
            case sendType:
                result = this._sendType;
                break;
            case sendMode:
                result = this._sendMode;
                break;
            case sender:
                result = this._sender;
                break;
            ...
            case sendMobile:
                result = this._sendMobile;
                break;

            case sendMessage:
                result = this._sendMessage;
                break;

            case sendTime:
                result = this._sendTime;
                break;

            case sendResult:
                result = this._sendResult;
                break;

            case sendMemo:
                result = this._sendMemo;
                break;
            default:
                result = "";
        }
    ...
    public static void main(String[] args) {
        ...
        CMessage_test msg = new CMessage_test(dImpl, "o113","o1");
//        CMessage_test msg = new CMessage_test(dImpl);
        try {
            dCn.beginTrans();
            /*
            String id1 = msg.addNew1();
                   ...
                   msg.update1();*/
            String id2 = msg.addNew2();
            msg.setValue(CMessage_test.sendType,"0");
            msg.setValue(CMessage_test.sendMode,"0");
            msg.setValue(CMessage_test.sender,"guanjia");
            msg.setValue(CMessage_test.sendTo,"guanjia");
            msg.setValue(CMessage_test.sendMobile,"13046683084");
            msg.setValue(CMessage_test.sendMessage,"hahahaha");
            msg.setValue(CMessage_test.sendTime,new CDate().getNowTime());
            msg.setValue(CMessage_test.sendResult,"0");
            msg.setValue(CMessage_test.sendMemo,"");
            msg.update2();
            dCn.commitTrans();
