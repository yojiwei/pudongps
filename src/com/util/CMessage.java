...
public class CMessage {
    ...
    private CMessage() {
        ...
        _sendResult = "0";
        _sendMemo = "";
        this._sendTime = new CDate().getNowTime().toString();
        this._msgSendTime = new CDate().getNowTime().toString(); //默认是当前时间发送
    }

    public CMessage(CDataImpl dImpl) {
        this();
        this._dImpl = dImpl;
    }
     ...
     * @param msgId  消息id
     */
    public CMessage(CDataImpl dImpl, String msgId) {
        this(dImpl);
    ...
    public void update() {
        ...
        this._dImpl.setValue("ma_receiverName", _msgReceiverName, CDataImpl.STRING);
    ...
    public static void main(String[] args) {
        ...
        try {
            dCn.beginTrans();
            /*String id1 = msg.addNew();
                   msg.setValue(CMessage.msgTitle,"duanxin测试");
                   msg.setValue(CMessage.msgContent,"duanxinduanxin测试");
                   ...
                   msg.setValue(CMessage.msgSendTime,"2003-10-10 09:45:45.000000000");
                   msg.update();*/
               //    msg.update1(CMessage.msgPrimaryId, "012");

           /* String id2 = msg.addNew2();
            msg.setValue(CMessage.sendType,"0");
            msg.setValue(CMessage.sendMode,"0");
            msg.setValue(CMessage.sender,"guanjia");
            msg.setValue(CMessage.sendTo,"guanjia");
            msg.setValue(CMessage.sendMobile,"13046683084");
            msg.setValue(CMessage.sendMessage,"hahahaha");
