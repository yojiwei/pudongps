 ...
 *
 */
public class ApplyOpenForm {
	private String systemname = "";// 默认此值 
	private String sender = ""; //系统标识
	...
	private String purpose = "";//所需政府信息的用途
	...
	private String dept = "";//选择相关受理部门
	//update 20090422
	private String free = "";//特别声明：个人需申请免除收费，主要理由
	private String filenum = "";//文号
	//关于附件
	private String filecontent = "";//文件内容 文件编码 base64编码
