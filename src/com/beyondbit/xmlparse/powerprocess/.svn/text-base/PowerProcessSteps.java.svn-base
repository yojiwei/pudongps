...
public interface PowerProcessSteps extends Serializable {

    public static final String ZEUS_XML_NAME = "PowerProcessSteps";
    public static final String[] ZEUS_ATTRIBUTES = {};
    public static final String[] ZEUS_ELEMENTS = {"PowerProcessStep"};
