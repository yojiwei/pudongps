...
public class EdocdataImpl extends DefaultHandler implements Cloneable, Unmarshallable, LexicalHandler, Edocdata {
    ...
    private static EdocdataImpl prototype = null;

    public static void setPrototype(EdocdataImpl prototype) {
        EdocdataImpl.prototype = prototype;
    }
    public static EdocdataImpl newInstance() {
        try {
            return (prototype!=null)?(EdocdataImpl)prototype.clone(): new EdocdataImpl();
    ...
    public static Edocdata unmarshal(File file) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file));
    }

    public static Edocdata unmarshal(File file, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file), validate);
    }

    public static Edocdata unmarshal(InputStream inputStream) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream));
    }

    public static Edocdata unmarshal(InputStream inputStream, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream), validate);
    }

    public static Edocdata unmarshal(Reader reader) throws IOException {
        // Delegate with default validation value
        return unmarshal(reader, false);
    }

    public static Edocdata unmarshal(Reader reader, boolean validate) throws IOException {
        EdocdataImpl edocdata = EdocdataImpl.newInstance();
        edocdata.setValidating(validate);
        edocdata.setCurrentUNode(edocdata);
        edocdata.setParentUNode(null);
        // Load the XML parser
        ...
        try {
            ...
            // Set error handler
            parser.setErrorHandler(edocdata);

            // Register lexical handler
            parser.setProperty("http://xml.org/sax/properties/lexical-handler", edocdata);

            // Register content handler
            parser.setContentHandler(edocdata);
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if ((localName.equalsIgnoreCase("edocdata")) && (!zeus_thisNodeHandled)) {
            // Handle ourselves
