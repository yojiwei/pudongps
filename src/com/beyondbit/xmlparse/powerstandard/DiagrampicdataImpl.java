...
public class DiagrampicdataImpl extends DefaultHandler implements Cloneable, Unmarshallable, LexicalHandler, Diagrampicdata {
    ...
    private static DiagrampicdataImpl prototype = null;

    public static void setPrototype(DiagrampicdataImpl prototype) {
        DiagrampicdataImpl.prototype = prototype;
    }
    public static DiagrampicdataImpl newInstance() {
        try {
            return (prototype!=null)?(DiagrampicdataImpl)prototype.clone(): new DiagrampicdataImpl();
        } catch (CloneNotSupportedException e) {
            return null; // never
        }
    }
    public DiagrampicdataImpl() {
        zeus_ValueSet = false;
        docTypeString = "";
        hasDTD = false;
        validate = false;
    ...
    public static Diagrampicdata unmarshal(File file) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file));
    }

    public static Diagrampicdata unmarshal(File file, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file), validate);
    }

    public static Diagrampicdata unmarshal(InputStream inputStream) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream));
    }

    public static Diagrampicdata unmarshal(InputStream inputStream, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream), validate);
    }

    public static Diagrampicdata unmarshal(Reader reader) throws IOException {
        // Delegate with default validation value
        return unmarshal(reader, false);
    }

    public static Diagrampicdata unmarshal(Reader reader, boolean validate) throws IOException {
        DiagrampicdataImpl diagrampicdata = DiagrampicdataImpl.newInstance();
        diagrampicdata.setValidating(validate);
        diagrampicdata.setCurrentUNode(diagrampicdata);
        diagrampicdata.setParentUNode(null);
        // Load the XML parser
        ...
        try {
            ...
            // Set error handler
            parser.setErrorHandler(diagrampicdata);

            // Register lexical handler
            parser.setProperty("http://xml.org/sax/properties/lexical-handler", diagrampicdata);

            // Register content handler
            parser.setContentHandler(diagrampicdata);
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if ((localName.equalsIgnoreCase("diagrampicdata")) && (!zeus_thisNodeHandled)) {
            // Handle ourselves
