...
public class IsopenImpl extends DefaultHandler implements Cloneable, Unmarshallable, LexicalHandler, Isopen {
    ...
    private static IsopenImpl prototype = null;

    public static void setPrototype(IsopenImpl prototype) {
        IsopenImpl.prototype = prototype;
    }
    public static IsopenImpl newInstance() {
        try {
            return (prototype!=null)?(IsopenImpl)prototype.clone(): new IsopenImpl();
    ...
    public static Isopen unmarshal(File file) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file));
    }

    public static Isopen unmarshal(File file, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file), validate);
    }

    public static Isopen unmarshal(InputStream inputStream) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream));
    }

    public static Isopen unmarshal(InputStream inputStream, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream), validate);
    }

    public static Isopen unmarshal(Reader reader) throws IOException {
        // Delegate with default validation value
        return unmarshal(reader, false);
    }

    public static Isopen unmarshal(Reader reader, boolean validate) throws IOException {
        IsopenImpl isopen = IsopenImpl.newInstance();
        isopen.setValidating(validate);
        isopen.setCurrentUNode(isopen);
        isopen.setParentUNode(null);
        // Load the XML parser
        ...
        try {
            ...
            // Set error handler
            parser.setErrorHandler(isopen);

            // Register lexical handler
            parser.setProperty("http://xml.org/sax/properties/lexical-handler", isopen);

            // Register content handler
            parser.setContentHandler(isopen);
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if ((localName.equalsIgnoreCase("isopen")) && (!zeus_thisNodeHandled)) {
            // Handle ourselves
