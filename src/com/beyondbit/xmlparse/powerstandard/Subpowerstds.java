...
public interface Subpowerstds extends Serializable {

    public static final String ZEUS_XML_NAME = "subpowerstds";
    public static final String[] ZEUS_ATTRIBUTES = {};
    public static final String[] ZEUS_ELEMENTS = {"subpowerstd"};
