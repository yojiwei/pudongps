...
public class DiagrampicstypeImpl extends DefaultHandler implements Cloneable, Unmarshallable, LexicalHandler, Diagrampicstype {
    ...
    private static DiagrampicstypeImpl prototype = null;

    public static void setPrototype(DiagrampicstypeImpl prototype) {
        DiagrampicstypeImpl.prototype = prototype;
    }
    public static DiagrampicstypeImpl newInstance() {
        try {
            return (prototype!=null)?(DiagrampicstypeImpl)prototype.clone(): new DiagrampicstypeImpl();
        } catch (CloneNotSupportedException e) {
            return null; // never
        }
    }
    public DiagrampicstypeImpl() {
        zeus_ValueSet = false;
        docTypeString = "";
        hasDTD = false;
        validate = false;
    ...
    public static Diagrampicstype unmarshal(File file) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file));
    }

    public static Diagrampicstype unmarshal(File file, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file), validate);
    }

    public static Diagrampicstype unmarshal(InputStream inputStream) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream));
    }

    public static Diagrampicstype unmarshal(InputStream inputStream, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream), validate);
    }

    public static Diagrampicstype unmarshal(Reader reader) throws IOException {
        // Delegate with default validation value
        return unmarshal(reader, false);
    }

    public static Diagrampicstype unmarshal(Reader reader, boolean validate) throws IOException {
        DiagrampicstypeImpl diagrampicstype = DiagrampicstypeImpl.newInstance();
        diagrampicstype.setValidating(validate);
        diagrampicstype.setCurrentUNode(diagrampicstype);
        diagrampicstype.setParentUNode(null);
        // Load the XML parser
        ...
        try {
            ...
            // Set error handler
            parser.setErrorHandler(diagrampicstype);

            // Register lexical handler
            parser.setProperty("http://xml.org/sax/properties/lexical-handler", diagrampicstype);

            // Register content handler
            parser.setContentHandler(diagrampicstype);
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if ((localName.equalsIgnoreCase("diagrampicstype")) && (!zeus_thisNodeHandled)) {
            // Handle ourselves
