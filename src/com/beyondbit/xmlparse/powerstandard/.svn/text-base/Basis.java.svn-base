...
public interface Basis extends Serializable {

    public static final String ZEUS_XML_NAME = "basis";
    public static final String[] ZEUS_ATTRIBUTES = {};
    public static final String[] ZEUS_ELEMENTS = {"name", "type", "effectdate", "unitname", "content"};
