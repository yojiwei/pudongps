...
public class Attr3idImpl extends DefaultHandler implements Cloneable, Unmarshallable, LexicalHandler, Attr3id {
    ...
    private static Attr3idImpl prototype = null;

    public static void setPrototype(Attr3idImpl prototype) {
        Attr3idImpl.prototype = prototype;
    }
    public static Attr3idImpl newInstance() {
        try {
            return (prototype!=null)?(Attr3idImpl)prototype.clone(): new Attr3idImpl();
    ...
    public static Attr3id unmarshal(File file) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file));
    }

    public static Attr3id unmarshal(File file, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new FileReader(file), validate);
    }

    public static Attr3id unmarshal(InputStream inputStream) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream));
    }

    public static Attr3id unmarshal(InputStream inputStream, boolean validate) throws IOException {
        // Delegate to the unmarshal(Reader) method
        return unmarshal(new InputStreamReader(inputStream), validate);
    }

    public static Attr3id unmarshal(Reader reader) throws IOException {
        // Delegate with default validation value
        return unmarshal(reader, false);
    }

    public static Attr3id unmarshal(Reader reader, boolean validate) throws IOException {
        Attr3idImpl attr3id = Attr3idImpl.newInstance();
        attr3id.setValidating(validate);
        attr3id.setCurrentUNode(attr3id);
        attr3id.setParentUNode(null);
        // Load the XML parser
        ...
        try {
            ...
            // Set error handler
            parser.setErrorHandler(attr3id);

            // Register lexical handler
            parser.setProperty("http://xml.org/sax/properties/lexical-handler", attr3id);

            // Register content handler
            parser.setContentHandler(attr3id);
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if ((localName.equalsIgnoreCase("attr3id")) && (!zeus_thisNodeHandled)) {
            // Handle ourselves
