...
public interface Powerstdsteps extends Serializable {

    public static final String ZEUS_XML_NAME = "powerstdsteps";
    public static final String[] ZEUS_ATTRIBUTES = {};
    public static final String[] ZEUS_ELEMENTS = {"powerstdstep"};
