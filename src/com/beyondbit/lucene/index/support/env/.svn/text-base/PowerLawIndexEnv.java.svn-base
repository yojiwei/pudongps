...
public class PowerLawIndexEnv extends java.util.HashMap implements IEnv {
    //索引�\uFFFD
   ...
   public PowerLawIndexEnv() {
        path  = getClass().getClassLoader().getResource("").
               getFile() + "../lucene_index/pl";
   }

   public PowerLawIndexEnv(IJob job) {
       this.create =((IndexPowerLawJob) job).isNewCreate();
       path = getClass().getClassLoader().getResource("").
           getFile() + "../lucene_index/pl";
   }
