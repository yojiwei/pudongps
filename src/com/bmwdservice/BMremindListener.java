 ...
 * @version 1.0
 * 调用上海浦东门户网站信息发布接口向.net添加便民提醒监听
 */

public class BMremindListener
    implements ServletContextListener {
    private static final int CYCLE = 60 * 60 * 24 * 1000;//24小时调一次
    private Logger logger;
    private OnlineWorkPoller onlineWorkPoller = null;
    private BMremind bm = null;

    public BMremindListener() {
        logger = Logger.getLogger(BMremindListener.class);
    }
