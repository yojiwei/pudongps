...
public class Service1Locator extends org.apache.axis.client.Service implements com.wgqservice.Service1 {

//	private String webserviceAdd = "";
	private ReadProperty pro ;
	
    public Service1Locator() {
    	pro = new ReadProperty();
    	Service1Soap12_address = pro.getPropertyValue("pudongserviceaddress");
    	Service1Soap_address = pro.getPropertyValue("pudongserviceaddress");
    }
    ...
    public com.wgqservice.Service1Soap_PortType getService1Soap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wgqservice.Service1Soap12Stub _stub = new com.wgqservice.Service1Soap12Stub(portAddress, this);
    ...
    public com.wgqservice.Service1Soap_PortType getService1Soap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wgqservice.Service1Soap_BindingStub _stub = new com.wgqservice.Service1Soap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.wgqservice.Service1Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wgqservice.Service1Soap12Stub _stub = new com.wgqservice.Service1Soap12Stub(new java.net.URL(Service1Soap12_address), this);
                _stub.setPortName(getService1Soap12WSDDServiceName());
                return _stub;
            }
            if (com.wgqservice.Service1Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wgqservice.Service1Soap_BindingStub _stub = new com.wgqservice.Service1Soap_BindingStub(new java.net.URL(Service1Soap_address), this);
                _stub.setPortName(getService1SoapWSDDServiceName());
                return _stub;
            }
        }
