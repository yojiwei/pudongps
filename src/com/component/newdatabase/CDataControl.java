...
public class CDataControl extends CError
{
   public CDataCn dataCn;
   ...
   */
   public CDataControl(CDataCn dCn)
   {
     try
     {
       /*
       ...
       */
       ...
       stmt = cn.createStatement(java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE,java.sql.ResultSet.CONCUR_UPDATABLE);
       //stmt = cn.createStatement(java.sql.ResultSet.TYPE_SCROLL_SENSITIVE,java.sql.ResultSet.CONCUR_UPDATABLE);
       //stmt = cn.createStatement();
       //stmt = cn.createStatement();
     }
     catch(Exception ex)
   ...
   */
   public long getMaxId(String tableName)
   {
     try
     {
       ...
       if (rs.next())
       {
         ...
         //strSql = "update tb_rowcount set RC_maxid=" + MaxId + " where RC_tablename = '"+ tableName +"'";
       ...
       {
         //strSql = "insert into tb_rowcount values ('"+ tableName +"',1)";
         //executeUpdate(strSql);
   ...
   public static void main(String[] args) {
      try{
        CDataControl x = new CDataControl();
