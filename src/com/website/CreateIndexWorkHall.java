...
public class CreateIndexWorkHall extends TimerTask{
    ...
    private void writeLogs(String b_status){
		...
		String log_levn = "首页办事动态页面";
		String log_description = log_levn+sm_nowtime+"生成"+b_status;
		//System.out.println("办事动态生成页面日志==="+log_description+" =="+b_status);
	...
	public static void main(String args[]){
		...
		String url_source = "http://localhost/website/index_workhallnew.jsp";
		String real_path = "F:\\pudongps\\WebRoot\\";
		String real_source = "\\website\\index_workhall.html";
