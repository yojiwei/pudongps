function jw(id,o){
	try{
		var tare = new Array("ldjh_qf","ldjh_qw");
		var obj = o;
		
		for(i = 0; i < tare.length; i++)		{
			eval("document.all."+tare[i]+".style.display='none';");
			eval("document.all."+tare[i]+"_b.className='f15_out';");
			eval("document.all."+tare[i]+"_b.style.color='#999999';");
			if(tare[i]==id) {o.className = "f15_on";eval("document.all."+tare[i]+".style.display='';");eval("document.all."+tare[i]+"_b.style.color='#FF0000';");}
