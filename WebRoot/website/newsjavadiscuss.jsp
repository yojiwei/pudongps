...
<table width="209" border="0" cellpadding="0" cellspacing="0" bgcolor="#F9F9F9">
  <tr>
    <td height="32" background="/website/pudongForum/images/NewsIndex_bg01_w.jpg">&nbsp;</td>
  </tr>
  <tr>
    <td height="10"></td>
  </tr>
  <tr>
    <td valign="top"><table width="191" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td align="left" valign="top"><img src="pudongForum/images/NewsIndex_icon02_w.jpg" width="70" height="21" /></td>
      </tr>
      <tr>
        <td valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="3">
          ...
          <tr>
            <td align="left" valign="top">
            	<a href="/website/pudongForum/index.jsp" target="_blank" class="newsf_wjj" title="<%=board_name%>"><%=board_name.length() >13 ? board_name.substring(0,12) + ".." : board_name%></a>
            </td>
          </tr>
          <tr>
            <td></td>
  ...
  <tr>
    <td valign="top"><table width="191" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td align="left" valign="top"><img src="/website/pudongForum/images/NewsIndex_icon03_w.jpg" width="70" height="21" /></td>
      </tr>
      <tr>
     ...
     %>
          <tr>
            <td width="18" height="21" align="left" valign="top"><img src="/website/pudongForum/images/NewsIndex_icon04_w.jpg" width="14" height="13" /></td>
  ...
  <tr>
    <td height="46" align="center" valign="middle"><a href="/website/pudongForum/index.jsp" target="_blank"><img src="/website/pudongForum/images/NewsIndex_icon01_w.jpg" width="77" height="24" border="0" /></a></td>
  </tr>
</table>
<%
}
