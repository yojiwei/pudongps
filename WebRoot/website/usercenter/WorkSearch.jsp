...
try{
dCn = new CDataCn();
dImpl_userleft = new CDataImpl(dCn);
...
//CDataCn workCn = new CDataCn();
CDataImpl workdImpl = new CDataImpl(dCn);

String sql_ondept = " select pr_name,pr_id from tb_proceeding where dt_idext="+selectid;

String sql_onwork = " select pr_name,pr_id from tb_proceeding where sw_id='"+selectid+"' ";

String sql_alldept = " select pr_name,pr_id from tb_proceeding where dt_idext is not null ";

String sql_allwork = " select pr_name,pr_id from tb_proceeding where sw_id is not null ";
              ...
              <%
                        ...
                        <td width="170"> · <a href="List.jsp?cw_id=<%=cw_id%>&uk_id=<%=uk_id%>"><font color=""#B49F66""><%=CW_NAME%></font></a></td></tr><tr><td height="3"></td>
                                   ...
                                   if(UK_ID.equals("o1")){
                                    ...
                                    %>>>&nbsp;&nbsp;<a href="List.jsp?uk_id=<%=uk_id%>"><font color=""#B49F66"">更多</font></a>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr><tr><td height="7">  </td><tr></table>
          </td>
        </tr><tr>
          <td width="178" height="17" colspan="2" background="../images/left_logo1.gif">
                                           <%
              ...
              <%
                        ...
                        <td width="170"> · <a href="List.jsp?cw_id=<%=cw_id%>&uk_id=<%=uk_id%>"><font color=""#B49F66""><%=CW_NAME%></font></a></td></tr><tr><td height="3"></td>
                                  ...
                                  uk_id=("o3");
                                    ...
                                    %>>>&nbsp;&nbsp;<a href="List.jsp?uk_id=<%=uk_id%>"><font color=""#B49F66"">更多</font></a>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr><tr><td height="7">  </td><tr>
          </table>
          </td>
        </tr>
        </table>
        ...
        <tr>
                <td width="178" valign="top">
                        <table width="178" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <form name="formSearch" action="../usercenter/WorkSearch.jsp" method="post">
                                <tr>
                                        <td><div align="center">办事检索</div></td>
                                </tr>
                                <tr height="30">
                                        <td><div align="center">
                                                <input type="text" name="keyword" size="15" style="color: #38529C; border: 1px solid #C0C0C0; padding: 0; background-color: #FFFFFF" onMouseOver="this.focus()"  onFocus="this.select()" value="输入关键字" onclick=this.value="">
                                                </div>
                                        </td>
                                </tr>
                                <tr height="30">
                                        <td><div align="center">
                                                <select style="border:1px solid #C0C0C0; color: #38529C; padding-top: 0; background-color: #FFFFFF" name="selecttype" onChange="javascript:fnChangeSelect(this.selectedIndex)">
            ...
            <br>
            <select style="color: #38529C; padding-top: 0; background-color: #FFFFFF" name="selectcontent">
              <option value="0">请选择</option>
                                ...
                                <tr height="30" align="center">
                                        <td>
                                                <input type="button" style="border:1px solid #C0C0C0; color: #38529C; background-color: #FFFFFF" name="btnSubmit" value="搜  索" onclick="checkForm()">&nbsp;
                                        </td>
                                </tr>
                          </form>
            </table>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0"><tr>
        ...
        <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
            <tr>
              <td width="543" height="76" background="../images/temp.gif" colspan="2" valign="top">&nbsp;&nbsp; 搜索结果
            <%
                                                                        if(selectid.equals("0")&&selecttype.equals("1"))
                                                                        {
                                                                                Vector vectoralldept = workdImpl.splitPage(sql_alldept,request,20);

                                                                                if(vectoralldept!=null)
                                                                                {
                                                                                        for(int i=0;i<vectoralldept.size();i++)
                                                                                        {
                                                                                                Hashtable content = (Hashtable)vectoralldept.get(i);
                                                                        ...
                                                                        {
                                                                                Vector vectorallwork = workdImpl.splitPage(sql_allwork,request,20);
                                                                                if(vectorallwork!=null)
                                                                                {
                                                                                        for(int i=0;i<vectorallwork.size();i++)
                                                                                        {
                                                                                                Hashtable content = (Hashtable)vectorallwork.get(i);
                                                                                                pr_name = content.get("pr_name").toString();
                                                                                                pr_id   = content.get("pr_id").toString();
                                                                        %>
                                                                                              <tr width="100%">
                                                                        ...
                                                                        if(!selectid.equals("0")&&selecttype.equals("1"))
                                                                        {
                                                                                Vector vectorondept = workdImpl.splitPage(sql_ondept,request,20);
                                                                                if(vectorondept!=null)
                                                                                {
                                                                                        for(int i=0;i<vectorondept.size();i++)
                                                                                        {
                                                                                                Hashtable content = (Hashtable)vectorondept.get(i);
                                                                                                pr_name = content.get("pr_name").toString();
                                                                                                pr_id   = content.get("pr_id").toString();
                                                                        %>
                                                                                               <tr width="100%">
                                                                        ...
                                                                        if(!selectid.equals("0")&&selecttype.equals("2"))
                                                                        {
                                                                                Vector vectoronwork = workdImpl.splitPage(sql_onwork,request,20);
                                                                                if(vectoronwork!=null)
                                                                                {
                                                                                        for(int i=0;i<vectoronwork.size();i++)
                                                                                        {
                                                                                                Hashtable content = (Hashtable)vectoronwork.get(i);
                                                                                                pr_name = content.get("pr_name").toString();
                                                                                                pr_id   = content.get("pr_id").toString();
                                                                        %>
                                                                                               <tr width="100%">
            ...
            <tr>
              <td width="543" height="21" background="../images/pint3.gif" colspan="2" align="center" valign="bottom"><table><tr><td><%=workdImpl.getTail(request)%></td></tr></table></td>
            </tr>
          </table>
          </td>
        </tr>
        ...
        <tr>
          <td width="543" height="20" colspan="2" valign="top" background="../images/pint3.gif"><img border="0" src="../images/tebtj.gif" width="80" height="20"></td>
        </tr>
        <tr>
...
<%
        ...
        <tr>
          <td width="543" height="20" colspan="2" valign="top" background="../images/pint3.gif"><img border="0" src="../images/changjwt.gif" width="120" height="20"></td>
        </tr>
        <tr>
          <td width="543" height="30" colspan="2">
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
...
<%
                      ...
                      Vector vPage2 = dImpl_userleft.splitPage(sqlStr_uk1,1000,1);
                      if (vPage2!=null)
                      {
