...
{
	var obj=new Array("baseinfo_bt","sheet_bt","bdform_bt");
...
{
	var layerobj=new Array("baseinfo","sheet","bdform");
...
{
	//var form = document.all.formData_selvalue;
	SelectAll("aa_trade");
...
function Editdirectory(sm_id,projectid,sort)
{
	...
	//window.showModalDialog("DirectoryEdit.jsp?sm_id=" + sm_id + "&pr_id=" + projectid + "&sort=" + sort,"","Top=100px,Left=200px,Width=580px, Height=500px,toolbar=no,location=no,derectories=no,status=no,menubar=no,scrollbars=no");
}
