...
document.write("<form name='dataupload' target=targetFrm action='http://usercenter.pudong.gov.cn/system/common/dataupload/DataUpload.jsp' method='post'>");
document.write("<input type='hidden' name='CT_title' value=''>");
document.write("<input type='hidden' name='CT_id' value=''>");
...
function getSbValues(title,content,createTime,source,attachStr,attachType,subjectId,ctId,dtId){
	
	document.dataupload.CT_title.value = title;
	document.dataupload.CT_id.value = ctId;
