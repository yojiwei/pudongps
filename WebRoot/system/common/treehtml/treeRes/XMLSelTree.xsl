...
<xsl:variable name="LeafImgSrc">treeRes/images/NodeImg0.gif</xsl:variable>
<xsl:variable name="BranchImgSrc">treeRes/images/NodeImg1.gif</xsl:variable>
			...
			<xsl:choose>
				<xsl:when test="@Href">
					<span type="link" class="Link">
						...
						<xsl:attribute name="englishName">
							<xsl:value-of select="@EnglishName" />
						</xsl:attribute>
						<xsl:attribute name="showFlag">
							<xsl:value-of select="@ShowFlag" />
						</xsl:attribute>
