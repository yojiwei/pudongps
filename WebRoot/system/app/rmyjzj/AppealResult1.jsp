...
//out.println(receiverId);
  ...
  if(!deptconn.equals(""))
  {
  	...
  	dImpl_conn.setValue("cp_id",deptconn,CDataImpl.STRING);  dImpl_conn.setValue("cw_applyingname",CTools.dealString(request.getParameter("applyname").trim()),CDataImpl.STRING);//投诉人姓名
	dImpl_conn.setValue("cw_applyingdept",CTools.dealString(request.getParameter("applydept").trim()),CDataImpl.STRING);//投诉人单位
		...
		dImpl_conn.setValue("cw_parentid",cw_id,CDataImpl.STRING);}
		else{
