            ...
            <%
              switch(cw_status)
              {
               case 1:
                 ...
                 out.print("<input class='bttn' value='转办' type='button' onclick='dovalidate(document.sForm)'  size='6' id='button3' name='button3'>&nbsp;");
