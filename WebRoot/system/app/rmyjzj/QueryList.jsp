...
sqlStr += "where a.cw_status in(" +status+ ") and b.cp_id = 'o11200' and a.cp_id=b.cp_id and b.dt_id=c.dt_id";
...
if(!"".equals(dtId)&&!"11883".equals(dtId)){
	...
	for (int i=0;i<vPage.size();i++)
	{
		...
		%>
				<tr width="100%" <%if (i%2==0) out.print("class='line-even'");else out.print("class='line-odd'");%>>
					...
					<td align="center"><%applyTime = content.get("cw_applytime").toString();out.print(applyTime);%></td>
