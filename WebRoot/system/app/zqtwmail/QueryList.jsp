...
<tr width="100%" class="bttn">
	...
	<td align="center" class="outset-table" width="11%" >处理部门</td>
...
sqlStr += " from tb_connwork a,tb_connproc b,tb_deptinfo c where (b.cp_id='o11958'or b.cp_upid='o11958') and a.cp_id=b.cp_id and b.dt_id=c.dt_id";
