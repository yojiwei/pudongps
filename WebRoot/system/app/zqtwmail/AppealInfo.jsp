...
String cw_id = "";//编号
  ...
  if(vectorPage!=null)
  {
   strSql = "select g.file_name,g.aa_id,c.cw_emailtype,c.cw_parentid,c.cw_id,c.us_id,c.cp_id,c.cw_code,c.cw_applyingname,c.cw_applyingdept,c.cw_email,c.cw_telcode,c.cw_appliedname,c.cw_applieddept,";
   ...
   strSql += "e.de_senddeptid,e.de_receiverdeptid,e.de_isovertime,e.de_requesttime,f.dt_name,c.cw_number ";
  ...
  else
  {
   strSql = "select cw_emailtype,cw_parentid,cw_id,us_id,cp_id,cw_code,cw_applyingname,cw_applyingdept,cw_email," +
   			...
   			"cw_applieddept,cw_subject,cw_content,cw_feedback,cw_applytime,cw_trans_id,cw_number from tb_connwork " +
   			"where cw_id='"+ cw_id +"'";
  }
...
String logstrModule = "受理走千听万安全隐患排查信件";
%>
  ...
  <form  method="post" name="sForm" enctype="multipart/form-data">
    <tr>
      <td width="100%" align="left" valign="top"><table class="content-table" height="1" width="100%">
		  ...
		  <tr class="line-odd">
            <td width="18%" align="right">信件流水号：</td>
            <td width="82%"><input type="text" class="text-line" name="cw_number" maxlength="100" size="30" title="信件流水号" value="<%=cw_number%>" readonly></td>
          </tr>
          <tr class="line-odd">
