...
try
{
  ...
  if(vectorPage!=null)
  {
   strSql = "select c.cw_id,c.us_id,c.cw_telcode,c.cp_id,c.cw_applyingname,c.cw_applyingdept,c.cw_email,c.cw_appliedname,c.cw_applieddept,";
  ...
  {
   strSql = "select cw_id,cp_id,us_id,cw_telcode,cw_applyingname,cw_applyingdept,cw_email,cw_appliedname,cw_applieddept,cw_subject,cw_content,cw_feedback from tb_connwork where cw_id='"+ cw_id +"'";
  }
  //out.println(strSql);
...
<!-- 记录日志 -->
<%
String logstrMenu = "沪东街道";
String logstrModule = "受理沪东信件";
%>
...
<form  method="post" name="sForm">
 ...
 <table class="content-table" height="1" width="100%">
            ...
            <tr class="line-odd">
              <td align="right">&nbsp;</td>
			  <td align="left"><font color='red'>*如果选择E_mail回复，请确定本地正确安装outlook软件</font></td>
            </tr>
            <tr class="line-even">
            ...
            <%
              switch(cw_status)
              {
               ...
               <%
                 break;
               case 2:
                 out.print("<input class='bttn' value='完成' type='button' onclick='finish(document.sForm)'  size='6' id='button1' name='button1'>&nbsp;");
                 out.print("<input class='bttn' value='E-mail回复' type='button' onclick='directDeal(document.sForm)'  size='6' id='button1' name='button1'>&nbsp;");
                 //out.print("<input class='bttn' value='处理完成' type='button' onclick='finish(document.sForm)'  size='6' id='button3' name='button3'>&nbsp;");
                 out.print("<input class='bttn' value='垃圾信件' type='button' onclick='garbage(document.sForm)'  size='6' id='button3' name='button4'>&nbsp;");
               %>
...
//		   var aa="aa";
  var form = document.sForm;
  var feedback = form.strFeedback.value;
 showModalDialog("outLook.jsp?eMail="+sForm.strEmail.value+"&eSubject="+sForm.strSubject.value+"&feedBack="+feedback,'dialogWidth:45px; dialogHeight:45; status:0; help:0; scroll:0; resizable:0');      
