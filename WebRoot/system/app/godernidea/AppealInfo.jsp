   ...
   <tr>
        <td width="100%" align="left" valign="top">
            ...
            <tr class="line-even">
			  ...
			  <td width="82%"><input type="text" class="text-line" name="strEmail" maxlength="10" size="30" value="<%=cw_applytime%>" readonly>
              </td>
            </tr>
            <tr class="line-odd">
			  ...
			  <td width="82%"> 
						  <select name="strSubject">
							<option value="经济发展" <%if(strSubject.equals("金点子信箱:经济发展")){out.print("selected");}%>>金点子信箱:经济发展</option>
							<option value="城市建设" <%if(strSubject.equals("金点子信箱:城市建设")){out.print("selected");}%>>金点子信箱:城市建设</option>
							<option value="市容环境" <%if(strSubject.equals("金点子信箱:市容环境")){out.print("selected");}%>>金点子信箱:市容环境</option>
							<option value="教育医疗" <%if(strSubject.equals("金点子信箱:教育医疗")){out.print("selected");}%>>金点子信箱:教育医疗</option>
							<option value="社会管理" <%if(strSubject.equals("金点子信箱:社会管理")){out.print("selected");}%>>金点子信箱:社会管理</option>
							<option value="就业保障" <%if(strSubject.equals("金点子信箱:就业保障")){out.print("selected");}%>>金点子信箱:就业保障</option>
							<option value="政府改革" <%if(strSubject.equals("金点子信箱:政府改革")){out.print("selected");}%>>金点子信箱:政府改革</option>
							<option value="科技创新" <%if(strSubject.equals("金点子信箱:科技创新")){out.print("selected");}%>>金点子信箱:科技创新</option>
						  </select>
			   </td>
            </tr>
			<%
            ...
            <%
              switch(cw_status)
              {
               ...
               case 8:
                 ...
                 out.print("<input class='bttn' value='垃圾信件' type='button' onclick='garbage(document.sForm)'  size='6' id='button4' name='button4'>&nbsp;");
				 out.print("<input class='bttn' value='撤销转办' type='button' onclick='garbage2(document.sForm)'  size='6' id='button5' name='button5'>&nbsp;");
                 break;
               case 3:
...
function setValue11()
  ...
  function garbage2(sForm)
  {
    if(window.confirm("您确定要撤销转办的信件吗？")){
