...
<form name="formData" method="post">
				<tr width="100%" class="bttn">
					...
					<td align="center" class="outset-table" width="10%" >处理部门</td>
					<td align="center" class="outset-table" width="11%" >处理时限</td>
					<td align="center" class="outset-table" width="5%" >受理超时</td>
					<td align="center" class="outset-table" width="12%" >办理超时</td>
					<td align="center" class="outset-table"  width="14%">操作</td>
				</tr>
<%
...
sqlStr = "select a.cw_status,a.cw_id,a.cp_id,a.cw_isovertime,a.cw_isovertimem,a.cw_applyingname,a.cw_subject,to_char(a.cw_applytime,'yyyy-mm-dd hh24:mi:ss') cw_applytime,b.cp_timelimit,b.cp_timelimiting,c.dt_name ";
sqlStr += "from tb_connwork a,tb_connproc b,tb_deptinfo c ";
sqlStr += "where b.cp_upid='o11919' and a.cp_id=b.cp_id and b.dt_id=c.dt_id";
