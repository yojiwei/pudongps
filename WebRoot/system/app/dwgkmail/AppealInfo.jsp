...
String cw_id = "";//编号
  ...
  {
   strSql = "select cw_id,cp_id,us_id,cw_code,cw_parentid,cw_transmittime,to_char(cw_applytime,'yyyy-mm-dd hh24:mi:ss') cw_applytime,cw_telcode,cw_applyingname,cw_addresscode,cw_applyingdept,cw_email,cw_appliedname,cw_applieddept,cw_subject,cw_content,cw_feedback from tb_connwork where cw_id='"+ cw_id +"'";
  }
          ...
          <td align="left">
            ...
            <select name="deptconn" onchange='setValue11();'>
                <option value="">请选择转交单位</option>
		                <%
										 String sqlStr="select c.cp_id, c.cp_name, c.dt_name from tb_connproc c, tb_deptinfo d where c.dt_id = d.dt_id and c.cp_upid = 'o11919' and c.cp_id !='o11895' order by cp_id";
				             Vector vPage = dImpl.splitPage(sqlStr,request,250);
								  ...
								  %>
             	<option value="<%=cp_id_jz%>"><%="党务公开领导信箱－"+cp_name_jz%></option>
             <%}}%>
             </select>
