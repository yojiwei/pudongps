...
<%!String Modify_Id,User_Name,User_Password,sql,User_Sex,User_Email,User_Address,User_Mobile,User_Oicq,User_Birthay,User_Icon,User_Sign;%>
<%
Connection con=yy.getConn();
Statement  stmt=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
ResultSet  rs=null;
Modify_Id=request.getParameter("modifyid");
sql="select * from USERINFO where ur_id="+Modify_Id;
...
if (rs.getRow()>0)
{
		...
		User_Oicq=rs.getString("ur_oicq");
...
<form method="post" name=form1  action="modifyuser_manage.jsp">                  
                  ...
                  <tr bgcolor="#FFFFFF"> 
                    ...
                    <td class="tablerow" height="25" width="486"> 
                      <input type="text"   name="name" size="30" maxlength="25" value=<%=User_Name%>>
                  ...
                  <tr bgcolor="#FFFFFF">        
                    ...
                    <td class="tablerow" height="25" width="486" bgcolor="#C6EFFF">        
                      <input type="text" name="password" size="30" value=<%=User_Password%>>       
                      <font color="#FF0000">***长度不能大于12小于6</font></td>         
                  </tr>       
                  <tr bgcolor="#FFFFFF">        
                    <td class="tablerow" height="25" width="235" bgcolor="#C6EFFF">用户等级</td>      
                    <td class="tablerow" height="25" width="486" bgcolor="#C6EFFF">       
                      <select size="1" name="userclass">
                      
					  <option selected><%=rs.getString("ur_grade")%></option>
                      <option>新手上路</option>
					  <option>初级会员</option>
					  <option>中级会员</option>
					  <option>高级会员</option>
                  ...
                  <tr bgcolor="#FFFFFF">       
                    <td class="tablerow" height="0" colspan="2" width="731" bgcolor="#C6EFFF">       
                      <div align="center">       
                        <input type="submit" name="regsubmit" value="修  改" />      
                      </div>      
                    </td>      
                  </tr>      
                  </form> 
