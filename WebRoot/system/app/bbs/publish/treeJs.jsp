...
var img_show = "../../common/treeview/images/img_show.gif"; //目录
var img_hide = "../../common/treeview/images/img_hide.gif"; //目录
var img_file_hide = new Array();
img_file_hide[0] = "../../common/treeview/images/img_file_0.gif"; //文件
img_file_hide[1] = "../../common/treeview/images/img_file_1.gif"; //文件
img_file_hide[2] = "../../common/treeview/images/img_file_2.gif"; //文件
img_file_hide[3] = "../../common/treeview/images/img_file_3.gif"; //文件
img_file_hide[4] = "../../common/treeview/images/img_file_4.gif"; //文件

//var img_file_hide = "../../common/treeview/images/img_file_hide.gif"; //文件

var img_hide_first = "../../common/treeview/images/img_hide_first.gif";
var img_show_first = "../../common/treeview/images/img_hide_first.gif";
...
{
        document.all.content.readOnly=(t!="true")?true:false;
}
...
function clearTree()
{
        ...
        if (parseInt(isSupportMultiSelect)==1)
        {
            var nodes = xmlDoc.XMLDocument.documentElement.selectNodes("item1");
            if (nodes)
            {
...
function turnit_node(nodeFlag,id,isFile)
{
       // alert(nodeFlag)
        ...
        if (node)
        {
                        ...
                        if (parseInt(isSupportMultiSelect)==1) //多选
                        {
                                //处理子节点和父节点
