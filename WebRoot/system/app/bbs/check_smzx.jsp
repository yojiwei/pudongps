...
try
{
   ...
   dImpl.setValue("post_flag","1",CDataImpl.STRING);	
   dImpl.update(); 
%>
...
if (dCn.getLastErrString().equals(""))
{
	...
	out.println("alert('"+"已成功审核！"+"');");	out.println("window.location.href='shownote_smzx.jsp?checkDel=true&fid="+fid+"&noteid="+noteid+"&page="+page1+"'");
	out.println("</script>");
}
else
{
