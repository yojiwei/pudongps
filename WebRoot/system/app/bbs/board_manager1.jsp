...
<%! String Notice_Id,sql,Not_Title,Not_Content,Submit_Button;%>
 <%
  ...
  sql="Select f.*,u.ur_realname from forum_board f,userinfo u where u.ur_loginname=f.fm_master_name order by fm_sequence";
    ...
    <td colspan="6" height="10" align="right" valign="middle"> 
      <div align="left"></div>
        <div align="center">论坛名称：
		  ...
		  斑竹：
          <input id=useid type=text name=user treeType=Dept treeTitle=选择部门用户 isSupportMultiSelect=0 isSupportFile=1
