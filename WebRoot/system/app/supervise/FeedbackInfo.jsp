...
sqlWait="select a.sv_type,a.sv_content,a.sv_feedback,b.de_id ,b.de_status,c.wo_projectname ,d.dt_id,d.dt_name from tb_supervise a,tb_documentexchange b ,tb_work c ,tb_deptinfo d  where a.sv_id='"+sv_id+"' and  a.sv_type='4' and (b.de_status='2' or b.de_status='5') and  a.sv_id=b.de_primaryid  and c.wo_id=a.SV_FOREIGNID and b.de_senddeptid=d.dt_id";
...
<br>
<textarea  name="sv_feedback" rows="6" cols="50" class = "text-line"  <%if (de_status.equals("5") || optype.equals("View")) out.println("readonly");%>><%=sv_feedback%></textarea>
 </td>
</tr>
...
%>
	...
	<input type=<%if (de_status.equals("5") || optype.equals("View")) out.println("hidden"); else out.println("reset");%> class="bttn"  value="重 写">&nbsp;
...
</form><%@include file="../skin/popbottom.jsp"%>
<%
