...
<%
String urgentlist = "";
urgentlist  = CTools.dealString(request.getParameter("urgentlist")).trim();
...
sqlWait="select a.ur_type,a.ur_content,b.de_id ,b.de_status,c.wo_projectname from tb_urgent a,tb_documentexchange b ,tb_work c where a.ur_id='"+ur_id+"' and  b.de_type='2'  and  a.ur_id=b.de_primaryid  and c.wo_id=a.UR_FOREIGNID";
