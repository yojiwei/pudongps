...
strTitle = "信息公开一体化 > 待补正材料";

sqlStr = "select i.id iid,i.infoid,i.infotitle,i.proposer,i.pname,i.ename,to_char(i.applytime,'yyyy-mm-dd') applytime,i.indexnum,i.flownum,i.commentinfo,i.signmode,i.dname,t.genre,t.id tid from infoopen i,taskcenter t,consult c where i.id = t.iid and i.id = c.iid and i.status = 5 and t.status = 0 and c.status<>2  and t.did="+dt_id+sqlWhere+" order by i.applytime desc";
...
<form name="formSearch" method="post" action="daiList.jsp">
