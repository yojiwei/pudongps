...
strTitle = "信息公开一体化 > 待办任务";

sqlStr = "select i.id iid,i.infoid,i.infotitle,i.proposer,i.pname,i.ename,to_char(i.applytime,'yyyy-mm-dd') applytime,i.indexnum,i.flownum,i.commentinfo,i.signmode,i.dname,t.genre,t.id tid from infoopen i,taskcenter t where i.id = t.iid and i.status = 1 and t.status = 0 and i.checktype<>9 and t.did="+dt_id+sqlWhere+" order by i.applytime desc";
...
<table class="FindAreaTable1" cellspacing="1" rules="cols" border="0" id="ctl00_DataGrid_DataGrid1" style="border-width:0px;">
				<tr class="">
					<td colspan="9" align="center"><form name="formSearch" method="post" action="taskList.jsp">
						<table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
							<tr>
								...
								<td align="left" nowrap><input class="bttn" type="button" value="高级检索 >>" onclick="javascript:window.location.href='searchTerm.jsp';" /> </td>
							</tr></form>
						</table>
					</td>
				</tr>
				...
				%>
					...
					<td align="center"><a href="taskInfo.jsp?iid=<%=content.get("iid")%>&tid=<%=content.get("tid")%>"><img class="hand" border="0" src="../../images/modi.gif" title="办理" WIDTH="16" HEIGHT="16"></a></td>
				</tr>
				<%
					}
					out.println("</form>");
