...
strTitle = "信息公开一体化 > 认领中心";

sqlStr = "select id,infoid,infotitle,proposer,pname,ename,to_char(applytime,'yyyy-mm-dd') applytime,indexnum,flownum,commentinfo,signmode,dname from infoopen where checktype!=9 and status = 0"+sqlWhere+" order by applytime";
...
<form name="formSearch" method="post" action="claimCenter.jsp">
<table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
	<tr>
		...
		<td align="left" nowrap><input class="bttn" type="submit" value="检索">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="button" value="认领" onclick="jobcheckup('claimIt.jsp','','8')"></td>
	</tr>
</table>
<table class="FindAreaTable1" cellspacing="1" rules="cols" border="0" id="ctl00_DataGrid_DataGrid1" style="border-width:0px;">
				...
				%>
					...
					<td align="center"><a href="applyView.jsp?iid=<%=content.get("id")%>"><img class="hand" border="0" src="../../images/modi.gif" title="查看申请表" WIDTH="16" HEIGHT="16"></a></td>
				</tr>
				<%
					}
					out.println("</form>");
