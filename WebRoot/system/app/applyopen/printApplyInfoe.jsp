...
<table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="24" align="right" valign="bottom" class="f14">申请人类别：法人或其他组织</td>
  </tr>
  <tr>
    <td>
    <table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#000000">
      <tr bgcolor="#FFFFFF">
        <td rowspan="5" align="center" valign="middle" width="6%">法人或其他组织</td>
        <td height="24" align="center" valign="middle" width="26%">名　称</td>
        <td colspan="2" valign="middle" id="ename" class="f14"></td>
        <td align="center" valign="middle" width="17%">组织机构代码</td>
        <td valign="middle" width="17%" id="ecode" class="f14"></td>
        </tr>
      <tr bgcolor="#FFFFFF">
        <td height="24" align="center" valign="middle">营业执照信息</td>
        <td colspan="4" valign="middle" id="ebunissinfo" class="f14"></td>
        </tr>
      <tr bgcolor="#FFFFFF">
        <td height="24" align="center" valign="middle">法人代表</td>
        <td colspan="2" valign="middle" id="edeputy" class="f14"></td>
        <td align="center" valign="middle" width="17%">联系人姓名</td>
        <td valign="middle" id="elinkman" class="f14"></td>
        </tr>
      <tr bgcolor="#FFFFFF">
        <td height="24" align="center" valign="middle">联系人电话</td>
        <td colspan="4" valign="middle" id="etele" class="f14"></td>
        </tr>
      <tr bgcolor="#FFFFFF">
        <td height="24" align="center" valign="middle">联系人电子邮箱</td>
        <td colspan="4" valign="middle" id="eemail" class="f14"></td>
        </tr>
      <tr bgcolor="#FFFFFF">
        <td rowspan="7" align="center" valign="middle"><strong>所需信息情况</strong></td>
        <td height="30" align="center" valign="middle">信息名称</td>
      ...
      <tr bgcolor="#FFFFFF">
        ...
        <td colspan="4" valign="middle" id="applytime" class="f14" id="applytime"></td>
        </tr>
    </table></td>
  </tr>
