...
try {
 ...
 dImpl = new CDataImpl(dCn); 
	String sqlStr = "select c.*,t.tc_id,t.tc_senderid from tb_content c,tb_taskcenter t where c.ct_id='" + ctId + "' and t.ct_id = c.ct_id and tc_isfinished='1' and tc_receiverid='" + mySelf.getMyID() + "' and rownum=1";
	out.println(sqlStr);
