...
try {
 ...
 dImpl = new CDataImpl(dCn); 
	String sqlStr = "select c.*,t.tc_id,t.tc_senderid,par.tc_memo,u.ui_name,t.sj_id as chkids from tb_content c,tb_taskcenter t,tb_taskcenter par,tb_userinfo u where u.ui_id=par.tc_senderid and c.ct_id='" + ctId + "' and t.ct_id = c.ct_id and t.tc_isfinished='0' and t.tc_receiverid='" + mySelf.getMyID() + "' and t.tc_parentid=par.tc_id and rownum=1";
	out.println(sqlStr);
