...
in_id = CTools.dealString(request.getParameter("in_id")).trim();//tb_image表中的ct_id
...
sqlStr = "select im_id from tb_image where ct_id='"+in_id+"' and im_name='"+fileName+"'";
...
else
{
	...
	out.print("window.location='PublishInfo.jsp?OPType=Edit&ct_id="+in_id+"&th_id="+th_id+"'");
}
