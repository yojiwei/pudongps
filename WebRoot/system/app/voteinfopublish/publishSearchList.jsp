...
//if(!sj_id.equals("0")) sWhere += " and ct.sj_id='" + sj_id + "'"; 
...
if(audit.equals(""))
{
  //strSql = "select t.ct_id,t.ct_create_time,t.ct_publish_flag,t.ct_focus_flag,t.ct_image_flag,t.ct_message_flag,t.ct_title,t.ct_sequence,t.dt_id,s.sj_name,d.dt_name from tb_content t,tb_subject s,tb_deptinfo d where 1=1 and t.dt_id=d.dt_id and t.sj_id=s.sj_id "+ sWhere +" order by to_date(t.ct_create_time,'YYYY-MM-DD') desc,t.ct_id desc";
            ...
            <td colspan="7" align="center">
                <table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
                    <tr>
						...
						<!--
						  <select class="select-a" name='dt_id' onchange=javascript:onChange()>
							<option value="" <%if (selDt_id.equals("")) out.println("selected");%>>请选择部门</option>
			<%

			//if (dtList != null)
			//{
				//for (int d=0;d<dtList.size();d++)
				//{
					//Hashtable dtContent = (Hashtable)dtList.get(d);
					//dt_id   = dtContent.get("dt_id").toString();
					//dt_name = dtContent.get("dt_name").toString();
			%>
							<option value="<%//=dt_id%>" <%//if(dt_id.equals(selDt_id)) out.println("selected");%>><%//=dt_name%></option>
			<%
				//}
			//}
			%>
                        ...
                        <td valign="center" align="right" nowrap>
                            ...
                            <!--img src="/system/images/new.gif" border="0" onclick="window.location='PublishInfo.jsp?OPType=Add&sj_id=<%=sj_id%>&subjectCode=<%=subjectCode%>&audit=false'" title="新增信息" style="cursor:hand" align="absmiddle" WIDTH="16" HEIGHT="16"-->
                            <!-- img src="/system/images/split.gif" align="middle" border="0" WIDTH="5" HEIGHT="8">
