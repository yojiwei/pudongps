...
String sqlStr = "select c.cp_id,c.cp_name,c.dt_name,c.cp_sequence from tb_connproc c,tb_deptinfo d where c.dt_id=d.dt_id and c.cp_upid='o7' or c.cp_id='o7' and d.dt_id=" + selfdtid + " order by cp_sequence,cp_id";
String cp_id = "";
String cp_name = "";
String dt_name = "";
String strTitle = "网上咨询事项列表";
...
<form name="formData">
  <tr class="bttn" width="100%">
    <td align="center" width="20%">网上咨询处理事项ID</td>
    <td align="center" width="30%">网上咨询处理事项名称</td>
    <td align="center" width="30%">网上咨询受理单位</td>
