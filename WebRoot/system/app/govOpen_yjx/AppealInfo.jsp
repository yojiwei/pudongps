...
<!-- 记录日志 -->
<%
String logstrMenu = "意见箱";
String logstrModule = "受理意见箱";
%>
    ...
    <tr>
      <td width="100%" align="left" valign="top"><table class="content-table" height="1" width="100%">
          ...
          <tr class="line-even" width="100%">
            <td width="100%" colspan="2" align="left"><a onclick="javascript:Display(2)" style="cursor:hand"><img border="0" src="/system/images/topplus.gif" WIDTH="16" HEIGHT="16" id="InfoImg2"></a> 回复：</td>
          </tr>
...
<script language="javascript">
  ...
  function withdraw()
  {
    window.location="/system/app/govOpen_yjx/AppealDrop.jsp?cw_id=<%=cw_id%>";
  }
