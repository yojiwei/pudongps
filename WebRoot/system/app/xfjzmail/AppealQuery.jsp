	...
	<tr class="line-even">
		<td align="right">信件主题</td>
		 <td align="left"> 
			...
			String sqlStr="select c.cp_id, c.cp_name, c.dt_name from tb_connproc c, tb_deptinfo d where c.dt_id = d.dt_id and c.cp_upid = 'o10000' or c.cp_id = 'o10000' and d.dt_id = '11883'order by cp_id";
			...
			<input type="text" name = "pr_name" class="text-line" size="40"/>
		</td>
	</tr> 
	<tr class="line-odd">
