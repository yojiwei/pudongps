...
String opinion = "";
String status = "";
String strTitle = "网上办事事务审批";
String projectId = "";
String pr_url = "";
String nowpage = "";//当前第几页
...
nowpage = CTools.dealString(request.getParameter("nowpage")).trim();
if (!projectId.equals(""))
{
	strTitle = "后台受理";
...
{
	isReadOnly = "readonly";
	sqlStr = "select a.wo_status,a.us_id,a.pr_id,a.wo_opinion,a.wo_projectname,a.wo_contactpeople,a.wo_tel,a.wo_address,a.wo_idcard,a.wo_postcode,a.wo_applypeople,a.wo_appertain,c.dt_name, b.pr_url";
...
function sendMsg(wo_id)
{
	...
	window.open(url,"给用户发消息","Top=0px,Left=0px,Width="+w+"px,Height="+h+"px,toolbar=no,location=no,derectories=no,status=no,menubar=no,resizable=no,scrollbars=no");
}
...
<form name="formReceive" method="post" enctype="multipart/form-data">
	...
	<tr>
		<td colspan="9">
			<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#E3E3E3">
				...
				<tr>
					<td height="25" bgcolor="#FFFFFF" align=left colspan="2">
					&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td height="25" align=left bgcolor="#FFFFFF" colspan="2">
					&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td height="25" bgcolor="#FFFFFF" colspan="2">
						...
						if(!pr_url.equals("")){
							...
							Hashtable owContent = dImpl.getDataInfo("select owt1_id from tb_onlineworkxmltype where pr_id='" + pr_id + "'");
							String owt1_id = "";
							if(owContent != null){
							...
							<table border="0" cellspacing="0" width="100%">
								<tr>
									<td width="5%">&nbsp;</td>
									<td align="left"><a title="<%=projectName%>" href="http://usercenter.pudong.gov.cn<%=pr_url%>?pr_id=<%=pr_id%>&wo_id=<%=wo_id%>&owt1_id=<%=owt1_id%>&wo_status=<%=status%>&back=1&asd=c2hwZGZhbw==&rfv=MDBBMzFFRjA2QzQyQkJDOTJFOEMwNzREMUQ4MkUwREE=" target="_blank">查看详细资料</a></td>
								</tr>
							</table>
							<%
							}
							...
							<table border="0" cellspacing="0" width="100%">
								<tr>
									<td width="5%">&nbsp;</td>
									<td align="left"><a title="<%=projectName%>" href="http://usercenter.pudong.gov.cn<%=pr_url%>&pr_id=<%=pr_id%>&wo_id=<%=wo_id%>&owt1_id=<%=owt1_id%>&wo_status=<%=status%>&back=1" target="_blank">查看详细资料</a></td>
								</tr>
							</table>
							<%
							}
	...
	<tr class="line-even">
		<td align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea cols="60" rows="7" name="wo_opinion" <%if(OPType.equals("View")) out.print("readonly");%>><%=opinion%></textarea></td>
	</tr>
	<tr class="line-odd">
	  ...
	  <td colspan="9" align="left">
		...
		<td align="left">
			<div>
				...
				if (!wo_id.equals(""))
				{
					sqlStr = "select ma_id from tb_message where ma_primaryid='"+wo_id+"' and ma_relatedtype='1' order by ma_sendtime desc";
	...
	<tr class="title1">
		<td colspan="9" align="center">
			...
			<input type="button" class="bttn" value="返回" onclick="window.location.href='WaitList.jsp?strPage=<%=nowpage%>'"/>&nbsp;
		</td>
	</tr>
	...
	<tr class="title1">
		<td colspan="9" align="center">
			...
			<!--input type="button" class="bttn" value="返回" onclick="javascript:window.history.go(-1);"--><input type="button" class="bttn" value="返回" onclick="window.location.href='WaitList.jsp?strPage=<%=nowpage%>'"/>&nbsp;
		</td>
	</tr>
	<%
	}
