...
<form name="formData" method="post">
        ...
        com.app.CMySelf mySelf = (com.app.CMySelf)session.getAttribute("mySelf");
				...
				sqlStr = "select a.wo_status,a.wo_id,a.pr_id,a.wo_isovertime,a.wo_applypeople,a.wo_projectname,to_char(a.wo_applytime,'yyyy-mm-dd hh24:mi:ss') wo_applytime,b.pr_timelimit ";
				sqlStr += "from tb_work a,tb_proceeding b ";
				sqlStr += "where a.wo_status in('3','4') and a.pr_id=b.pr_id and b.dt_id="+dtId ;
