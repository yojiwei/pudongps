...
if (!sqlStr.equals(""))
{
	...
	if (vPage!=null)
	{
		for (int i=0;i<vPage.size();i++)
		{
			...
			String id = content.get("categoryid").toString();
			String name = content.get("categoryname").toString();
			cIds += "'"+ id +"'" + ",";
			%>
...
%>
	...
	<tr class="line-even" width="100%">
		...
		<td align="left">
			<span style="width:6px"> </span>
			<input name="title" size="40" class="text-line" value="<%=keyword%>">&nbsp;&nbsp;
	...
	<tr class="line-odd" width="100%">
		...
		<td align="left">
			<span style="width:6px"> </span>
			<select name="content" class="select-a" size="6" style="width:500px" ondblclick="delSelect()">
			<%
			if (!categoryid.equals(""))
			{
				...
				if (vPage!=null)
				{
					...
					{
						Hashtable content = (Hashtable)vPage.get(i);
						String id = content.get("contentid").toString();
