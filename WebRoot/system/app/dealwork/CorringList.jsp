...
String status="";
String overtitle="";
sqlCorring="select  x.wo_projectname,x.wo_sparehour,x.wo_isovertime,x.wo_status, x.wo_applypeople, to_char(x.wo_applytime,'yyyy-mm-dd hh24:mi:ss') wo_applytime, x.wo_id, x.pr_id,y.pr_timelimit from tb_work x,tb_proceeding y,tb_deptinfo z where x.wo_status='8' and x.pr_id=y.pr_id and y.dt_id="+selfdtid+" and y.dt_id=z.dt_id order by x.wo_applytime desc";
