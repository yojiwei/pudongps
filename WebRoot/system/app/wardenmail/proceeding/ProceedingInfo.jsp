...
<form action="ProceedingInfoResult.jsp" method="post" name="formData">
      <tr class="line-even" >
        <td  colspan=2>请填写信件处理事项资料：（注意带有<font color=red>*</font>的项目必须填写）</td>
                  </tr>
      <tr class="line-odd">
        <td align="right">信件处理事项名称：</td><td align="left"><input type="text" name="cp_name" value="<%=cp_name%>" class="text-line"> <font color=red>*</font></td>
      </tr>
      <tr class="line-odd">
      ...
      <tr class="line-odd">
        <td align="right">转办时限：</td><td align="left"><input type="text" name="corr_time" value="<%=corr_time%>" class="text-line" onKeyDown="floatOnly(value)" maxlength="7"> 天 <font color=red>*</font></td>
      </tr>
