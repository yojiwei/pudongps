...
String sqlStr = "select c.cp_id,c.cp_name,c.dt_name from tb_connproc c,tb_deptinfo d where c.dt_id=d.dt_id and c.cp_upid='o1' or c.cp_id='o1' and d.dt_id=" + selfdtid + "order by cp_name";
String cp_id = "";
String cp_name = "";
String dt_name = "信访办";
String strTitle = "区长信箱事项列表";
//update20080122
...
<!--    功能按钮开始    -->
<img src="../../../images/new.gif" border="0" onclick="window.location='ProceedingInfo.jsp?cp_id=<%=cp_id%>&dt_name=<%=dt_name%>'" title="新区长信件处理" style="cursor:hand" align="absmiddle" WIDTH="16" HEIGHT="16">
新增
...
<form name="formData">
  <tr class="bttn" width="100%">
    <td align="center" width="20%">区长信件处理事项ID</td>
    <td align="center" width="30%">区长信件处理事项名称</td>
    <td align="center" width="30%">区长信件受理单位</td>
