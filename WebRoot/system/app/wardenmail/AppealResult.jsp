...
try {
 ...
 strStatus = request.getParameter("cw_status").toString();
...
if(!deptconn.equals("")&&strStatus.equals("8"))
  ...
  if("1".equals(ispublish))  dImpl.setValue("cw_ispublish","1",CDataImpl.STRING);
  if (strStatus.equals("2")) dImpl.setValue("cw_managetime",FinishTime,CDataImpl.DATE); //开始处理时间
  dImpl.update();
  
  dImpl.setClobValue("cw_feedback",CTools.dealString(request.getParameter("strFeedback")));
  //投诉反馈
