...
sqlStr = "select a.cw_status,a.cw_id,a.cp_id,a.cw_isovertime,a.cw_isovertimem,a.cw_applyingname,a.cw_subject,to_char(a.cw_applytime,'yyyy-mm-dd hh24:mi:ss') cw_applytime,b.cp_timelimit,w.wd_name,b.cp_timelimiting ";
sqlStr += "from tb_connwork a,tb_connproc b,tb_warden w ";
sqlStr += "where (b.cp_id='o1'or b.cp_upid='o1' or b.cp_id='mailYGXX') and a.wd_id=w.wd_id";
	...
	for (int i=0;i<vPage.size();i++)
	{
		...
		%>
				<tr width="100%" <%if (i%2==0) out.print("class='line-even'");else out.print("class='line-odd'");%>>
					...
					<td nowrap><%=content.get("wd_name").toString()%></td>
