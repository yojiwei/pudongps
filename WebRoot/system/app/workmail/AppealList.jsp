...
str_sql = "select st_id,st_name,st_tel,st_content,st_kind,st_netaddress,st_applydate from tb_suggestmail where st_code = 'wrong'";
if(intStatus==3){
	str_sql += " and st_restatus in (2,3)";
}else{
	str_sql += " and st_restatus = "+st_status+"";	
}
str_sql += "  order by st_applydate desc";
...
<table class="FindAreaTable1" cellspacing="1" rules="cols" border="0" id="ctl00_DataGrid_DataGrid1" style="border-width:0px;">
                <tr class="bttn">
                        ...
                        <td width="25%" class="outset-table">报错人</td>
                        <td width="25%" class="outset-table">联系方式</td>
                        <td width="45%" class="outset-table">错误信息</td>
				...
				if(vectorPage != null) {
				  ...
				  %>
          			<td align="center"><center><%=kk%></center></td>
          			<td width="25%" align="left"><%=content.get("st_name")%></td>
			          <td width="25%" align="left"><%=content.get("st_tel")%></td>
			          <td width="45%" align="left"><%=content.get("st_content")%></td>
