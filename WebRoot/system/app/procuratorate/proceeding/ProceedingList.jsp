...
String sqlStr = "select c.cp_id,c.cp_name,c.dt_name from tb_connproc c,tb_deptinfo d where c.dt_id=d.dt_id and c.cp_upid='o8' or c.cp_id='o8' and d.dt_id=" + selfdtid + " order by c.cp_name";
String cp_id = "";
String cp_name = "";
String dt_name = "检察院";
String strTitle = "检察院事项列表";
//update20080122
...
<form name="formData">
  <tr class="bttn" width="100%">
    <td align="center" width="10%">检察院事项ID</td>
    <td align="center" width="40%">检察院事项名称</td>
    <td align="center" width="30%">检察院单位</td>
