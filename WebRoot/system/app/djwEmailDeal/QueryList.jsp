...
<!--    模块名称开始    -->
<font size="2"><%="o140".equals(cp_id)?"党建咨询":"监督投诉"%>信件列表</font>
<!--    模块名称结束    -->
...
<form name="formData" method="post">
				<tr width="100%" class="bttn">
					...
					<td align="center" class="outset-table" width="16%" >处理时限</td>
...
sqlStr = "select a.cw_status,a.cw_id,a.cp_id,a.cw_isovertime,a.cw_isovertimem,a.cw_applyingname,a.cw_subject,to_char(a.cw_applytime,'yyyy-mm-dd hh24:mi:ss') cw_applytime,b.cp_timelimit,b.cp_timelimiting ";
sqlStr += "from tb_connwork a,tb_connproc b,tb_deptinfo c ";
sqlStr += "where b.cp_id='"+cp_id+"'  and a.cp_id=b.cp_id and b.dt_id=c.dt_id";
