...
if(intStatus==8)
 {
  str_sql="select distinct c.cw_id,c.cp_id,c.cw_applyingname,c.cw_applyingdept,c.cw_subject,to_char(c.cw_managetime,'yyyy-mm-dd hh24:mi:ss') cw_managetime,c.cw_isovertime,c.cw_isovertimem,to_char(c.cw_applytime,'yyyy-mm-dd hh24:mi:ss') cw_applytime,to_char(c.cw_finishtime,'yyyy-mm-dd hh24:mi:ss') cw_finishtime,p.cp_timelimit,q.dt_id,p.cp_timelimiting from tb_connwork c,tb_deptinfo d,tb_connproc p,tb_connproccorr q where  p.cp_id='o12007' and c.cp_id=p.cp_id and p.cp_id=q.cp_id and c.cw_status=" + cw_status;
 }
else
 str_sql="select distinct c.cw_id,c.cp_id,c.cw_applyingname,c.cw_applyingdept,c.cw_subject,to_char(c.cw_managetime,'yyyy-mm-dd hh24:mi:ss') cw_managetime,c.cw_isovertime,c.cw_isovertimem,to_char(c.cw_applytime,'yyyy-mm-dd hh24:mi:ss') cw_applytime,to_char(c.cw_finishtime,'yyyy-mm-dd hh24:mi:ss') cw_finishtime,p.cp_timelimit,p.cp_timelimiting from tb_connwork c,tb_deptinfo d,tb_connproc p where p.cp_id='o12007' and c.cp_id=p.cp_id and c.cw_status=" + cw_status;
