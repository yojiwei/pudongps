...
strSql +=" d.dt_id from tb_content t,tb_subject s,tb_deptinfo d,tb_contentpublish ct,tb_contentpublish cp,tb_taskcenter tk where t.dt_id=d.dt_id and s.sj_id=ct.sj_id and ct.ct_id=t.ct_id and cp.ct_id=t.ct_id and tk.ct_id=ct.ct_id and tk.tc_receiverid='" + uiid + "' and tk.tc_isfinished='0' and tc_tasktype='0' order by to_date(t.ct_create_time,'YYYY-MM-DD') desc,t.ct_id desc" ;
...
%>
                ...
                <a href="PublishCheck.jsp?OPType=Check&ct_id=<%=content.get("ct_id")%>"><%=content.get("ct_title")%></a></td>
                <td align="center"></td>
                ...
                <td align="center"><a href="PublishCheck.jsp?OPType=Edit&ct_id=<%=content.get("ct_id")%>&subjectCode=<%=subjectCode%>&curpage=<%=CTools.dealNumber(request.getParameter("strPage"))%>&audit=<%=audit%>"><img class="hand" border="0" src="
                <%
