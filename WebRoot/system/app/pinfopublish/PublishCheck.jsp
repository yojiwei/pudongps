...
try {
 ...
 dImpl = new CDataImpl(dCn); 
	...
	String sqlStr = "select c.*,ct_content,t.tc_id,t.tc_senderid from tb_content c,tb_taskcenter t ,tb_contentdetail d where d.ct_id=c.ct_id and c.ct_id='" + ctId + "' and t.ct_id = c.ct_id and tc_isfinished='0' and tc_receiverid='" + mySelf.getMyID() + "' and rownum=1";
	//out.println(sqlStr);
