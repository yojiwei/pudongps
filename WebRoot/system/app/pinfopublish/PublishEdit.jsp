...
<table class="main-table" width="100%">
		<form name="formData" action="publishResult.jsp" method="post" enctype="multipart/form-data" >
					 <tr class="line-even" >
			            ...
			            <td width="81%" align='left'><input type="text" name="ctTitle"  class="text-line" size="80" value="<%=ctTitle%>"/> <font color="#FF0000">*</font>
			            </td>
			          </tr>
			          <tr class="line-even" >
		 ...
		 <input type="text" size=50 name="Module" class="text-line" style="cursor:hand" treeType="Subject" value="<%=Module_name%>" treeTitle="选择所属栏目" readonly isSupportMultiSelect="1" isSupportFile="0" onclick="chooseTree('Module');formData.Module.value=formData.Module.value.replace(/\x02/ig,',');"> <font color="#FF0000">*</font>
		 ...
		 <input type="hidden" name="ft_parent_id" value="<%=sj_id%>">
					  ...
					  <tr class="line-even" >
			            ...
			            <td width="81%" align='left'><input type="text" name="ctCreateTime" class="text-line" value="<%=ctCreateTime%>" readonly="true" onclick="javascript:showCal()" style="cursor:hand"/> <font color="#FF0000">*</font>
			            </td>
			          </tr>
