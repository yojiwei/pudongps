...
function setSequence(list_id,id)
{
	var form = document.formData ;
	form.list_id.value = list_id ;
	form.action = "setSequence.jsp?type=" + id ;
	form.submit();
}
</script>
<%
...
<form name="formData" method="post" action="frontRadioList.jsp">
 <tr>
                                ...
                                <table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
                                        <tr>
                                                ...
                                                <td valign="center" align="right" nowrap>
                                                        ...
                                                        <img src="/system/images/new.gif" border="0" onclick="window.location='radioInfo.jsp?list_id=<%=list_id%>'" title="增加信息" style="cursor:hand" align="absmiddle" WIDTH="16" HEIGHT="16">
														<img src="/system/images/dialog/split.gif" align="middle" border="0">
														<img src="/system/images/dialog/sort.gif" border="0" onclick="setSequence('<%=list_id%>','2')" title="修改排序" style="cursor:hand" align="absmiddle" id="image2" name="image2" WIDTH="16" HEIGHT="16">
                                                        <img src="/system/images/split.gif" align="middle" border="0" WIDTH="5" HEIGHT="8">
...
if (vPage != null)
{
  for(int j=0;j<vPage.size();j++)
  {
   ...
   sUrl="radioInfo.jsp?fi_id=" + content.get("id").toString() + "&list_id="+list_id;
