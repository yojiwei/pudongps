...
<form action="frontSubjectInfoResult.jsp" method="post" name="formData">
   ...
   <tr >
     <td width="100%" align="left" valign="top"colspan="2">
      ...
      <tr class="line-even">
        <td align="right">栏目名称：</td><td align="left"><input type="text" name="fs_name" value="<%=fs_name%>" class="text-line"> <font color=red>*</font></td>
      </tr>
      <tr class="line-even">
        <td align="right">栏目代码：</td><td align="left"><input type="text" name="fs_code" value="<%=fs_code%>" class="text-line"> <font color=red>*</font></td>
      </tr>
	  <tr class="line-even">
