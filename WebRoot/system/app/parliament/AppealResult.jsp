...
try {
 ...
 dImpl = new CDataImpl(dCn); 
  ...
  CDataImpl dImpl_source = new CDataImpl(dCn); //新建数据接口对象
  ...
  String cw_subject = cw_subject+"：您的信访事项有最新反馈信息，请登录“上海浦东”门户网站或通过电子邮件查询。";
...
out.println(receiverId);
  ...
  if(!deptconn.equals(""))
  {
  	...
  	dImpl_conn.setValue("cw_applyingname",CTools.dealString(request.getParameter("applyname").trim()),CDataImpl.STRING);//投诉人姓名
		...
		dImpl_conn.setValue("cw_emailtype",cw_emailtype,CDataImpl.STRING);//信箱类型
        dImpl_conn.update();
