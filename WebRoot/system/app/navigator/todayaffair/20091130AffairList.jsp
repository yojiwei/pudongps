						...
						<td>
							<table width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<%
										  ...
										  int count = 0;
										  int count1 = 0;
											String dclywSql = "select count(*) as count from tb_work a,tb_proceeding b,tb_deptinfo c where a.wo_status = 1 and a.wo_projectname like '" + "%"+"%' and a.wo_applypeople like '"+"%"+"%' and a.pr_id = b.pr_id and b.dt_id = c.dt_id and c.dt_id = " + dt_id;
								...
								<tr class="line-odd" width="100%" colspan="2">
									<td valign="center" width="15%" align="left"><span style="font:黑体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;·事项受理 --&gt; <a href="#" onclick="javascript:parent.parent.main_content.location.href='../../dealwork/WaitList.jsp?Menu=事项受理&Module=待处理业务'">待处理业务</a>(共
								<%
								   		out.print(count + " 条)");
								%>
										</span></td>
								...
								<%
											...
											String qzxxSql = "SELECT count(decode(c.cw_status,'1','1','')) a1,count(decode(c.cw_status,'2','1','')) a2 FROM tb_connwork c,tb_deptinfo d," +
																			 ...
																			 "and p.dt_id = " + dt_id + " and p.dt_id=d.dt_id";
											//out.println(qzxxSql);
								...
								<%
											...
											String tsxxSql = "select count(decode(c.cw_status,'1','1','')) a1,count(decode(c.cw_status,'2','1','')) a2 from tb_connwork c,tb_deptinfo d,tb_connproc p where " +
																			 "c.cp_id=p.cp_id and (p.cp_id='o4'or p.cp_upid='o4') and p.dt_id = " +
								...
								<%
										...
										String xfxxSql = "select count(decode(c.cw_status,'1','1','')) a1,count(decode(c.cw_status,'2','1','')) a2 from tb_connwork c,tb_deptinfo d,tb_connproc p where " +
										 								 "(p.cp_id='o5' or p.cp_upid='o5') and c.cp_id=p.cp_id and p.dt_id = " +
										 								 dt_id + " and p.dt_id=d.dt_id";
								...
								<%
											rs = null;
											count = 0;
											String dxalSql = "select count(*) count from tb_conncase cs where to_char(cs.cs_date,'yyyy-mm') ='"+sendTime+"' and cs.dt_id=" + dt_id + " order by cs.datecreated desc";
											//out.println(dxalSql);
