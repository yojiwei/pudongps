    ...
    if(sForm.strEmail.value!="")
     {
       if(isEmail(sForm.strEmail.value)==true)
      {
       ...
       {
       	 showModalDialog("outLook.jsp?eMail="+sForm.strEmail.value,'dialogWidth:45px; dialogHeight:45; status:0; help:0; scroll:0; resizable:0');
	       var form = document.sForm;
