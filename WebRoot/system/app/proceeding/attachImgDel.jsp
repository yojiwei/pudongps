...
String Img_path = CTools.dealString(request.getParameter("pr_imgpath"));
String File_name =CTools.dealString(request.getParameter("Filename")) ;
String sqlStr = "select im_id from tb_image where im_path='" + path + Img_path + "\\\\" + "'and im_filename='"+File_name+"'";
...
if (successDel)
{
	...
	out.print("window.location='attachInfoImg.jsp?pr_imgpath="+Img_path+"'");
	out.print("</SCRIPT>");    
}
else
{
