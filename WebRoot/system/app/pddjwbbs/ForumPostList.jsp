...
<form action="/system/app/pddjwbbs/ForumPostEdit.jsp" method="post" name="formrepAdd">
	...
	if(post_revert_count.equals(null)||post_revert_count.equals("")||post_revert_count.equals("0"))
			...
			post_revert_count ="0";	
				...
				Hashtable content_content = cdImpl.getDataInfo(sql_sql);
