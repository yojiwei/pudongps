...
<table WIDTH="100%" CELLPADDING="0" cellspacing="0" BORDER="0">
	...
	<table cellspacing="0" cellpadding="0" border="0" align="center"
		...
		<tr>
			...
			vPage = cdImpl.splitPage(sqlStr,request,100);
			if (vPage!=null)
			{
...
<input name="board_create_date" style="cursor:hand" class="text-line" readonly size="10" onclick="showCal()" value="<%=ul_time%>">
	...
	<div id="subdiv" style="display:none" >正在提交数据...</div>
		...
		&nbsp; <input type="button" name="Del" value="删除"  <%=us_uid.equals("djwbbs_01") ? "" : "disabled"%> onClick="deleteThis('<%=board_id%>','<%=board_hot_flag%>')"/>
