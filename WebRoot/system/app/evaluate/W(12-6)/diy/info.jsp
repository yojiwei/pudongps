...
strTitle = "<a href=list.jsp?upperid=0>投票列表</a> - " + strTitle;
...
if(OType.equals("Edit"))
{
	String sqlStr_editid = "select * from tb_votediy where vt_id= " + vt_id+"";
...
if(!upperid.equals("0"))
{
	...
	if(!tempid_showvote.equals(""))
	{
		...
		else out.print("<option value='"+tempid_showvote+"'>"+tempid_showvotename+"</option>");
		Vote vote = new Vote();
		vote.getVoteTitle(tempid_showvote);
		Vector votetitle = vote.RetuenVectorVoteTitle();
		if(votetitle!=null)
		{
...
if(upperid.equals("0"))
{
	/*
	out.print("<tr class='line-odd'>");
	out.print("<td align='right'>简介：</td>");
	out.print("<td>");
	out.print("<textarea class='text-line' rows='6' cols='90' name='vt_desc'>"+vt_desc+"</textarea>");
	out.print("</td>");
	out.print("</tr>");	*/
	%>
	<tr class="line-odd">
