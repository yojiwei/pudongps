...
while(!tempupperid.equals("0"))
{
	...
	if(!content.get("vt_name").toString().equals(""))
		strTitle = "<a href='"+request.getRequestURL()+"?upperid="+content.get("vt_id").toString()+"&uppername="+content.get("vt_name").toString()+"'>" + content.get("vt_name").toString() + "</a> - " + strTitle;
	if(content.get("vt_name").toString().equals(""))
		strTitle = "[<a href='"+request.getRequestURL()+"?upperid="+content.get("vt_id").toString()+"&uppername="+content.get("vt_name").toString()+"'>空</a>] - " + strTitle;
	tempupperid = content.get("vt_upperid").toString();
}
strTitle = "<a href="+request.getRequestURL()+"?upperid=0>投票列表</a> - " + strTitle;
                                ...
                                <table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
                                        <tr>
												...
												%>
														...
														<a href="list.jsp?upperid=<%=upupperid%>"><img src="../../../images/up.gif" border="0" title="上一级" align="absmiddle"></a>
														<img src="../../../images/split.gif" align="middle" border="0" WIDTH="5" HEIGHT="8">
														<a href="listtree.jsp?treeid=<%=tempid_showvote%>">树状视图</a>
													<%}%>
														<img src="../../../images/split.gif" align="middle" border="0" WIDTH="5" HEIGHT="8">
														<a href="info.jsp?OType=Add&upperid=<%=upperid%>"><img src="../../../images/new.gif" border="0" title="新建" align="absmiddle"></a>
														<img src="../../../images/split.gif" align="middle" border="0" WIDTH="5" HEIGHT="8">
...
if(vPage != null)
{
	for(int i=0;i<vPage.size();i++)
	{
		...
		if(!content.get("vt_name").toString().equals(""))
			out.print("<td align='left'><a href='"+request.getRequestURL()+"?upperid="+content.get("vt_id").toString()+"'>"+content.get("vt_name").toString()+"</a></td>");
		else
		...
		out.print("<td align='center'><a href='info.jsp?upperid="+upperid+"&editid="+content.get("vt_id").toString()+"&OType=Edit'><img src='../../../images/modi.gif' border='0' title='修改'></a></td>");
...
{
	PageForm.action = "setSequence.jsp?upperid=<%=upperid%>";
	PageForm.submit();
}
//-->
</SCRIPT>
