...
String sql_massage = " select * from tb_examine3 order by em_id desc";
%>
  	...
  	<td width="100%">
        ...
        <form name="formData">
        	<tr class="title1">
            	<td colspan="26" align="center">
                	<table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
                  	  <tr width="100%">
                      	  <td valign="center" width="60%">浦东新区卫生（医疗）系统行风状况调查问卷</td>
			...
			<tr class="bttn">
            		...
            		<td width="20%" class="outset-table" align="center">其它（请注明）</td>
            		...
            		<td width="20%" class="outset-table" align="center">其它</td>
            		<td width="20%" class="outset-table" align="center">建议和要求</td>
            		<td width="5%" class="outset-table" align="center">查看</td>
            		<td width="5%" class="outset-table" align="center">删除</td>
			</tr>
		<%
