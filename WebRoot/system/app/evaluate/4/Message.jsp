...
String sql_massage = " select * from tb_examine4 order by em_id desc";
%>
  	...
  	<td width="100%">
        ...
        <form name="formData">
        	<tr class="title1">
            	<td colspan="31" align="center">
                	<table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
                  	  <tr width="100%">
                      	  <td valign="center" width="60%">浦东新区居住物业管理行业--社区行风评议问卷调查表</td>
			...
			<tr class="bttn">
            		...
            		<td width="8%" class="outset-table" align="center">其它（请注明）</td>
            		<td width="2%" class="outset-table" align="center">房型</td>
            		<td width="8%" class="outset-table" align="center">街道（镇）</td>
            		<td width="8%" class="outset-table" align="center">路</td>
            		<td width="8%" class="outset-table" align="center">弄</td>
            		<td width="8%" class="outset-table" align="center">物业管理单位</td>
            		<td width="2%" class="outset-table" align="center">1</td>
            		<td width="2%" class="outset-table" align="center">2</td>
            		...
            		<td width="8%" class="outset-table" align="center">建议和要求</td>
		...
		if(vector_message!=null)
		{
			for(int i=0;i<vector_message.size();i++)
			{
				...
				if(em_q1_2_1.length()>11)
					em_q1_2_1=em_q1_2_1.substring(0,11)+"...";
				if(em_q3_1.length()>11)
					em_q3_1=em_q3_1.substring(0,11)+"...";
				if(em_q3_2.length()>11)
					em_q3_2=em_q3_2.substring(0,11)+"...";
				if(em_q3_3.length()>11)
					em_q3_3=em_q3_3.substring(0,11)+"...";
				if(em_q4.length()>11)
					em_q4=em_q4.substring(0,11)+"...";
				if(em_q6.length()>11)
					em_q6=em_q6.substring(0,11)+"...";
		...
		%>
			...
			<td align="center"><%=em_q1_2_1%></td>
			<td align="center"><%=em_q2%></td>
			<td align="center"><%=em_q3_1%></td>
			<td align="center"><%=em_q3_2%></td>
			<td align="center"><%=em_q3_3%></td>
			<td align="center"><%=em_q4%></td>
			<td align="center"><%=em_q5_1_1%></td>
			<td align="center"><%=em_q5_1_2%></td>
			<td align="center"><%=em_q5_1_3%></td>
			<td align="center"><%=em_q5_2_1%></td>
			<td align="center"><%=em_q5_2_2%></td>
			<td align="center"><%=em_q5_2_3%></td>
			<td align="center"><%=em_q5_2_4%></td>
			<td align="center"><%=em_q5_3_1%></td>
			<td align="center"><%=em_q5_3_2%></td>
			<td align="center"><%=em_q5_3_3%></td>
			<td align="center"><%=em_q5_3_4%></td>
			<td align="center"><%=em_q5_3_5%></td>
			<td align="center"><%=em_q5_4_1%></td>
			<td align="center"><%=em_q5_4_2%></td>
			<td align="center"><%=em_q5_4_3%></td>
			<td align="center"><%=em_q5_4_4%></td>
			<td align="center"><%=em_q5_4_5%></td>
			<td align="center"><%=em_q5_4_6%></td>
			<td align="center"><%=em_q5_4_7%></td>
			<td align="center"><%=em_q5_4_8%></td>
			<td align="center"><%=em_q6%></td>
		...
		<%
	      ...
	      out.println("<tr><td colspan=31>" + dImpl.getTail(request) + "</td></tr>"); //输出尾部文件
		}
       else
      {
          out.println("<tr><td colspan=31>没有记录！</td></tr>");
      }
  		%>
    </table>
    </td>
