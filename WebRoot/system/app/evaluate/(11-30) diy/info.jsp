...
out.print("<td><input type='text' name='vt_name' size='80' value='"+vt_name+"' class='text-line'></td>");
out.print("</tr>");
...
out.print("<td><input type='text' name='vt_sequence' size='3' value='"+vt_sequence+"' class='text-line'></td>");
out.print("</tr>");
if(upperid.equals("0"))//根节点
{
	%>
	<tr class="line-odd">
		<td align='right' width='16%'>发布时间</td><td><input type="text" name="vde_starttime"  value="<%=vde_starttime%>" onclick="javascript:showCal()" class=text-line style="cursor:hand" readonly ></td>
	  </tr>
	<tr class="line-odd">
		<td align='right' width='16%'>结束时间</td><td><input type="text" name="vde_finishtime"  value="<%=vde_finishtime%>" onclick="javascript:showCal()" class=text-line style="cursor:hand" readonly ></td>
	  </tr>
	<tr class="line-odd">
