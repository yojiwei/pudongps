...
<%
  ...
  try
  {
  	...
  	path = dImpl.getInitParameter("attach_save_path"); //获取路径
    ...
    sDocument = request.getParameter("DL_directory_name1");
    ...
    response.sendRedirect("attachInfo.jsp?DL_directory_name="+sDocument);
