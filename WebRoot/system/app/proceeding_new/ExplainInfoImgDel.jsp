...
String path = ""; //获取路径
String Img_path = "";
String img_Path_Part01 = "";
String img_Path_Part02 = "";
String img_Path_Part03 = "";
...
try{
	...
	Img_path = CTools.dealString(request.getParameter("pr_img"));
	img_Path_Part01 = Img_path.substring(0,4);
	img_Path_Part02 = Img_path.substring(4,6);
	img_Path_Part03 = Img_path.substring(6,Img_path.length());
	Img_path = img_Path_Part01+"-"+img_Path_Part02+"-"+img_Path_Part03;
	File_name =CTools.dealString(request.getParameter("Filename")) ;
