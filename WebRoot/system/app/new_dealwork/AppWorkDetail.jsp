...
{
	strTitle = "后台受理";
	sqlStr = "select pr_name from tb_proceeding_new where pr_id='"+projectId+"'";
...
{
	isReadOnly = "readonly";
	sqlStr = "select a.wo_status,a.us_id,a.pr_id,a.wo_opinion,a.wo_projectname,a.wo_contactpeople,a.wo_tel,a.wo_address,a.wo_idcard,a.wo_postcode,a.wo_applypeople,a.wo_appertain,c.dt_name, b.pr_url from tb_work a,tb_proceeding_new b,tb_deptinfo c where a.wo_id='"+wo_id+"' and a.pr_id=b.pr_id and b.dt_id=c.dt_id";
...
function openCorrForm(wo_id,pr_id)
{
	var w=750;
	var h=450;
	var url="../new_cooperate/CorrForm.jsp?OPType=Corr&wo_id="+wo_id+"&pr_id="+pr_id;
	...
	<tr>
		<td colspan="9">
			<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#E3E3E3">
				...
				<tr>
					<td height="25" bgcolor="#FFFFFF" colspan="2" align="left">
					&nbsp;&nbsp;&nbsp;&nbsp;
						递交材料
					</td>
				</tr>
				<tr>
					<td height="25" bgcolor="#FFFFFF" colspan="2" align="left">
						...
						{
							sqlStr = "select pa_id,pa_name from tb_proceedingattach_new where pr_id='"+projectId+"' and pa_upload='1'";
							Vector vPage = dImpl.splitPage(sqlStr,100,1);
							if (vPage!=null)
							{
							%>
						...
						if(!pr_url.equals("")){
							...
							<table border="0" cellspacing="0" width="100%">
								<tr>
									<td width="5%">&nbsp;</td>
									<td align="left"><a title="<%=projectName%>" href="<%=pr_url%>?pr_id=<%=pr_id%>&wo_id=<%=wo_id%>&owt1_id=<%=owt1_id%>&wo_status=<%=status%>&back=1&asd=c2hwZGZhbw==&rfv=MDBBMzFFRjA2QzQyQkJDOTJFOEMwNzREMUQ4MkUwREE=" target="_blank">查看详细资料</a></td>
								</tr>
							</table>
							<%
							}
							...
							<table border="0" cellspacing="0" width="100%">
								<tr>
									<td width="5%">&nbsp;</td>
									<td align="left"><a title="<%=projectName%>" href="<%=pr_url%>&pr_id=<%=pr_id%>&wo_id=<%=wo_id%>&owt1_id=<%=owt1_id%>&wo_status=<%=status%>&back=1" target="_blank">查看详细资料</a></td>
								</tr>
							</table>
							<%
							}
