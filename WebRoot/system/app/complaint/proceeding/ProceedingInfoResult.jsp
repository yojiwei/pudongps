...
try {
 ...
 dImpl = new CDataImpl(dCn); 
  ...
  if(actiontype.equals("add"))			//新增事项
  {
	...
	//判断事项名称是否重复，若重复返回重新填写
	String sqlHasName = "select cp_id from tb_connproc where cp_name = '"+ cp_name +"' and cp_upid = 'o5'";
	...
	if (rs_sh.next()) {
     ...
     dImpl.setValue("cp_upid","o5",CDataImpl.STRING);//事项上级id
  }
  else  //修改事项
  {
