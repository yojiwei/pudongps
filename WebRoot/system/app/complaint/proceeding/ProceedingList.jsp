...
String sqlStr = "select c.cp_id,c.cp_name,c.dt_name from tb_connproc c,tb_deptinfo d where c.dt_id=d.dt_id and c.cp_upid='o5' or c.cp_id='o5' and d.dt_id=" + selfdtid + "order by c.cp_name";
String cp_id = "";
String cp_name = "";
String dt_name = "信访办";
String strTitle = "信访事项列表";
//update20080122
...
<form name="formData">
  <tr class="bttn" width="100%">
    <td align="center" width="10%">信访处理事项ID</td>
    <td align="center" width="40%">信访处理事项名称</td>
    <td align="center" width="30%">信访受理单位</td>
