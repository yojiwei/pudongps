...
sqlUndo += " where x.de_type='6' and x.de_status in('2','4') and z.cp_id=v.cp_id and x.de_receiverdeptid='"+dt_id+"'";
                ...
                <tr class="title1">
                    <td colspan="12" align="center">
                        <table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
                            <tr width="100%">
                                <td valign="center" width="15%">待处理互动协调单</td>
            ...
            <td width="8%" class="outset-table" align="center">接收部门</td>
                ...
                %>
                            ...
                            %></td>
                                ...
                                <td align="center">
                                 <a href="CorrInfo.jsp?cw_id=<%=content.get("cw_id").toString()%>&CorrType=deal">处理</a>
                                </td>
            </tr>
</form>
<%
