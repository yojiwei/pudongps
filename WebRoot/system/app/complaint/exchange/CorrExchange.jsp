...
sqlUndo += " where x.de_type='6' and (x.de_status='1' or x.de_status='4') and z.cp_id=v.cp_id and x.de_receiverdeptid='"+dt_id+"'";
sqlUndo += " and x.de_primaryid=y.co_id and y.cw_id=z.cw_id and x.de_senddeptid=u.dt_id and x.de_receiverdeptid=w.dt_id order by x.de_feedbacksigntime desc,x.de_feedbacktime desc,x.de_signtime desc,x.de_sendtime desc";
%>
                ...
                <tr class="title1">
                    <td colspan="12" align="center">
                        <table WIDTH="100%" BORDER="0" CELLSPACING="1" CELLPADDING="1">
                            <tr width="100%">
                                <td valign="center" width="15%">互动协调单交换箱</td>
            ...
            <td width="8%" class="outset-table" align="center">接收部门</td>
                ...
                %>
                            ...
                            %></td>
                                ...
                                <td align="center">
                                 <a href="SignCorr.jsp?de_senddeptid=<%=content.get("de_senddeptid")%>&de_status=<%=content.get("de_status")%>&de_id=<%=content.get("de_id")%>&co_id=<%=content.get("co_id")%>&cw_id=<%=content.get("cw_id").toString()%>">签收</a>
                                </td>
            </tr>
</form>
<%
