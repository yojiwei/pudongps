...
<%
    response.sendRedirect("PublishEditZB.jsp");
%>
     ...
     <tr>
       ...
       <tr class="line-even" >
             ...
             <tr class="line-even" >
               ...
               <td width="81%" ><input type="text" name="ctSubTitle"  class="text-line" size="40"/>
               </td>
             </tr>
             <tr class="line-even" >
             ...
             <tr class="line-even" >
               ...
               <td width="81%" ><input type="text" name="ctGuildTitle"  class="text-line" size="40"/>
               </td>
             </tr>
             <tr class="line-even" >
       ...
       <tr class="line-even" >
            ...
            <input type="hidden" name="ft_parent_id" value="<%=sj_id%>">
             ...
             <tr id=infoOpen style="display:none" class="line-even" >
             	 ...
             	 <td width="81%" ><input type="text" class="text-line" size="40" name="IN_CATCHNUM" maxlength="150"  value="" ></td>
             </tr>
