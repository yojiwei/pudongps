...
if(myProject!=null && myProject.isLogin()){
  dtid = Long.toString(myProject.getDtId());
}


String strSql="";
strSql = "select distinct t.sj_name, t.ct_id,t.ct_create_time,t.ct_title,t.ct_updatetime,t.ct_publish_flag,t.dt_id,t.dt_name,ct_sequence,t.sj_id from tb_content t,tb_contentpublish ct ,tb_subject s,tb_contentcomment cc where s.sj_dir = 'govOpen_tzym' and t.dt_id = "+ dtid +" and ct.sj_id =s.sj_id and ct.ct_id=t.ct_id and to_number(cc.cc_corid_value) = t.ct_id order by to_date(t.ct_create_time,'YYYY-MM-DD') desc,t.ct_id desc" ;
//out.println(strSql);
...
%>
                ...
                <td ><img border="0" src="/system/images/arrow_yellow.gif" WIDTH="15" HEIGHT="13">&nbsp;&nbsp;<a href="PublishEdit.jsp?OPType=Tingzheng&ct_id=<%=content.get("ct_id")%>&subjectCode=&curpage=<%=CTools.dealNumber(request.getParameter("strPage"))%>&audit="><%=content.get("ct_title")%></a></td>
                ...
                <td align="center" nowrap><a href="PublishEdit.jsp?OPType=Tingzheng&ct_id=<%=content.get("ct_id")%>&subjectCode=&curpage=<%=CTools.dealNumber(request.getParameter("strPage"))%>&audit=">
