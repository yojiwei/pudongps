...
<%
  String ctGuildTitle = ""; //周报肩题
  String ctTitle = "";
  String ctSubTitle = ""; //周报副标题
  String ctKeywords = "";
  String ctUrl = "";
  String ctSource = "";
...
try {
 ...
 dImpl = new CDataImpl(dCn); 
  ...
  else
  {
    ...
    if(content!=null)
    {
      ctGuildTitle = content.get("ct_guildtitle").toString();
      ctTitle = content.get("ct_title").toString();
      ctSubTitle = content.get("ct_subtitle").toString();
...
<html>
 ...
 <body  style="overflow-x:hidden;overflow-y:auto">
  <form name="formData" action="publishResultZB.jsp" method="post" enctype="multipart/form-data" >
  ...
  <tr class="title1" align=center>
     ...
     <tr>
      ...
      <tr class="line-even" id=divType style="display:none" >
             ...
             <tr class="line-even" >
               <td width="19%" align="right">肩题：</td>
               <td width="81%" ><input type="text" name="ctGuildTitle"  class="text-line" size="40" value="<%=ctGuildTitle%>">
               </td>
             </tr>
             <tr class="line-even" >
               <td width="19%" align="right">主题：</td>
               <td width="81%" align='left'><input type="text" name="ctTitle"  class="text-line" size="40" value="<%=ctTitle%>"/>
               &nbsp;&nbsp;特别提醒：<input type="checkbox" name="ctFocusFlag" class="text-line" value="1" <%if(ctFocusFlag.equals("1")) out.println("checked");%>> <font color="#FF0000">（勾选后新闻标题显示红色）</font>
               </td>
             </tr>
             <tr class="line-even" >
               <td width="19%" align="right">副标题：</td>
               <td width="81%" ><input type="text" name="ctSubTitle"  class="text-line" size="40" value="<%=ctSubTitle%>">
               </td>
             </tr>
             <tr class="line-even" >
