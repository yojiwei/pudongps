...
/*得到当前登陆的用户id  结束*/
String strSql="";
/*strSql = "select distinct t.sj_name, t.ct_id,t.ct_create_time,t.ct_title,t.ct_updatetime,t.ct_publish_flag,t.dt_id,d.dt_name,ct_sequence,t.sj_id from tb_content t,tb_deptinfo d,tb_contentpublish ct ,tb_subject s,tb_contentcomment cc where ct.sj_id =s.sj_id and t.dt_id=d.dt_id " + sWhere + " and ct.ct_id=t.ct_id and to_number(cc.cc_corid_value) = t.ct_id order by to_date(t.ct_create_time,'YYYY-MM-DD') desc,t.ct_id desc" ;*/

strSql = "select * from (select distinct t.sj_name, t.ct_id,t.ct_create_time,t.ct_title,t.ct_updatetime,t.ct_publish_flag,t.dt_id,d.dt_name,ct_sequence,t.sj_id,cc.cc_corid_value from tb_content t,tb_deptinfo d,tb_contentpublish ct,tb_subject s,tb_contentcomment cc where ct.sj_id =s.sj_id and t.dt_id=d.dt_id " + sWhere + " and ct.ct_id=t.ct_id) dd where to_number(dd.cc_corid_value) = dd.ct_id order by to_date(dd.ct_create_time,'YYYY-MM-DD') desc,dd.ct_id desc" ;
  ...
  <td width="100%">
       <table class="content-table" width="100%">
        ...
        <tr class="bttn">
            ...
            <td width="10%" class="outset-table">更新时间</td>
            <td width="10%" class="outset-table">评论数</td>
...
%>
                ...
                <td ><img border="0" src="/system/images/arrow_yellow.gif" WIDTH="15" HEIGHT="13">&nbsp;&nbsp;<a href="PublishEdit.jsp?OPType=Edit&ct_id=<%=content.get("ct_id")%>&subjectCode=&curpage=<%=CTools.dealNumber(request.getParameter("strPage"))%>&audit="><%=content.get("ct_title")%></a></td>
                ...
                <td align="center" nowrap><a href="PublishEdit.jsp?OPType=Edit&ct_id=<%=content.get("ct_id")%>&subjectCode=&curpage=<%=CTools.dealNumber(request.getParameter("strPage"))%>&audit="><img class="hand" border="0" src="
                <%               
