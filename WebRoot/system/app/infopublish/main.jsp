...
<%
String url=CTools.dealNull(request.getParameter("url"),"publishList.jsp");
%>
<html>
<head>
...
<tr>
<td height=500 width=60 valign=200><iframe width=200 height=500 name="left" noresize src="left.jsp"></iframe></td>
...
//document.all.left.style.height= (document.body.clientHeight-80) + "px";
//document.all.main.style.height= (document.body.clientHeight-80) + "px";
</script>
