...
if(node_title.equals("天气预报"))response.sendRedirect("../weather/weatherList.jsp");
...
//我的短信频道不与你们同流合污！
String mysql="select s.sj_name from tb_subject s connect by prior s.sj_id=s.sj_parentid start with sj_dir='dxpd'";
ResultSet myrs=dImpl.executeQuery(mysql);
while(myrs.next())
{
	String mysj_name=CTools.dealNull(myrs.getString("sj_name"));
	if(node_title.equals(mysj_name)){
