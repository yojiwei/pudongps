...
<form name="formData" method="post" action="count_subList.jsp"  target="">
    ...
    <td colspan="2">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				...
				<td align="right"><img src="../../images/goback.gif" border="0" onclick="javascript:window.history.back();" title="返回" style="cursor:hand" align="absmiddle">&nbsp;&nbsp;</td>
			<tr>
		</table>
	</td>
  </tr>
  ...
  <%
	...
	String sj_dir = "";
	String hrefUrl = "";
	sj_id = "".equals(sj_id) ? "26239" : sj_id;					//如果sj_id为空
 ...
 dImpl = new CDataImpl(dCn); 
	...
	if (vPage != null) {
		for (int i = 0;i < vPage.size();i++) {
			...
			f_sj_dir = "'" + f_sj_dir + "',";
			hrefUrl = f_sj_dir.equals(sj_dir) ? tb_name : "<a href=\"lgw_count_subList.jsp?sj_id=" + sj_id + "&start_date=" + begtime + "&end_date=" + endtime + "\"> " + tb_name + "</a>";
			if (tb_count != 0) {
				kk++;
  %>
