...
String strSql="";
strSql = "select distinct t.sj_name, t.ct_id,t.ct_create_time,t.ct_title,t.ct_updatetime,t.ct_publish_flag,t.dt_id,ct_sequence,t.sj_id from tb_content t,tb_contentpublish ct ,tb_subject s,tb_contentcomment cc where s.sj_dir = 'govOpen_wjym' and ct.sj_id =s.sj_id and ct.ct_id=t.ct_id and to_number(cc.cc_corid_value) = t.ct_id order by to_date(t.ct_create_time,'YYYY-MM-DD') desc,t.ct_id desc" ;
//out.println(strSql);
...
%>
                ...
                <td align="center" nowrap>
								&nbsp;<a href="PublishEdit.jsp?OPType=Edit&ct_id=<%=content.get("ct_id")%>&subjectCode=&curpage=<%=CTools.dealNumber(request.getParameter("strPage"))%>&audit=">
