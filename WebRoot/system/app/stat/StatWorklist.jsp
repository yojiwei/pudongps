       ...
       <table class="content-table" width="100%">
		...
		%>
				<tr width="100%" <%if (i%2==0) out.print("class='line-even'");else out.print("class='line-odd'");%>>
					...
					<td align="center"><%=dt_name%>
					</td>
					<td align="center">网上办事事项
					</td>
					<%
					...
					%>
					<td align="center"><%=content_cw.get("count(a.wo_id)").toString()%></td>
                                        <%
					  ...
					  count2 += Integer.parseInt(content_cw1.get("count(a.wo_id)").toString());
                                        %>
                                        <td align="center"><%=content_cw1.get("count(a.wo_id)").toString()%></td>
                                        </td>
                                        <%
					  ...
					  count3 += Integer.parseInt(content_cw2.get("count(a.wo_id)").toString());
                                        %>
                                        <td align="center"><%=content_cw2.get("count(a.wo_id)").toString()%></td>
                                        </td>
                                        <%
					  ...
					  count4 += Integer.parseInt(content_cw3.get("count(a.wo_id)").toString());
                                        %>
                                        <td align="center"><%=content_cw3.get("count(a.wo_id)").toString()%></td>
                                        </td>
                                        <%
					  ...
					  count5 += Integer.parseInt(content_cw4.get("count(a.wo_id)").toString());
                                        %>
                                        <td align="center"><%=content_cw4.get("count(a.wo_id)").toString()%></td>
                                        </td>
					</tr>
				<%
				        }
