...
String strDt = "";
String sqlStr_dt = "";
sqlStr_dt = "select dt_id,dt_name from tb_deptinfo order by dt_sequence";
...
<form name="formData" method="post" action="InfoOpenConnlist.jsp">
            <tr class="title1">
                <td align="left" width="100%" colspan="2">依申请公开汇总统计表&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
...
function fnsubmit(flag)
{
	...
	{
		document.formData.action="InfoOpenConnlist.jsp";
	}
