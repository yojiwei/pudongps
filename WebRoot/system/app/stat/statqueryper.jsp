...
<form name="errquery" action="statlist.jsp" method="post">
<table border=0 cellspacing="1" cellpadding="0" width="100%">
<tr class="bttn"><td colspan="2">统计分析查询
</td></tr>

<tr class="line-odd"><td width="15%" align="right" >操&nbsp;作&nbsp;人</td>
...
<!--<tr class="line-odd"><td width="15%" align="right">操作方式</td>
