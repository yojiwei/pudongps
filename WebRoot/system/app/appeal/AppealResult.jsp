...
String strStatus = request.getParameter("cw_status").toString();	//受理状态
try {
 dCn = new CDataCn(); 
 dImpl = new CDataImpl(dCn); 
	...
	String appealdept = CTools.dealString(request.getParameter("appealdept"));
	String appealname = CTools.dealString(request.getParameter("appealname"));
	...
	if(!deptconn.equals("")&&strStatus.equals("8"))
  {
    	...
    	dImpl.setValue("cw_applyingname",CTools.dealString(request.getParameter("applyname").trim()),CDataImpl.STRING);//投诉人姓名
			...
			dImpl.setValue("cw_appliedname",CTools.dealString(request.getParameter("appealname").trim()),CDataImpl.STRING);//被投诉人姓名
			dImpl.setValue("cw_applieddept",CTools.dealString(request.getParameter("appealdept").trim()),CDataImpl.STRING);//被投诉人单位
      ...
      dImpl.setValue("cw_code",CTools.dealString(request.getParameter("cp_id").trim()),CDataImpl.STRING);//投诉主题
	    ...
	    dImpl.setValue("cw_typecode",cw_typecode,CDataImpl.STRING);	
