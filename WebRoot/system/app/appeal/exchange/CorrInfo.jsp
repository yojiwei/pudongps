...
try
{
 ...
 String strSql = "select c.cp_id,c.cw_applyingname,c.cw_applyingdept,c.cw_email,c.cw_telcode,c.cw_appliedname,c.cw_applieddept,c.cw_subject,c.cw_content,c.cw_status,d.co_id,";
...
<table WIDTH="100%" CELLPADDING="0" BORDER="0" class="main-table">
            ...
            <tr class="line-odd">
              <td width="18%" align="right">提 交 人：</td>
            ...
            <tr class="line-even">
              ...
              <td width="82%"><input class="text-line" type="text" name="appealname" maxlength="100" size="30" title="投诉人" value="<%=appealname%>"readonly></td>
            </tr>
            <tr class="line-odd">
              <td width="18%" align="right">单　　位：</td>
              <td width="82%"><input class="text-line" type="text" name="appealdept" maxlength="100" size="30" title="单位" value="<%=appealdept%>" readonly></td>
            </tr>
            <tr class="line-even">
                ...
                <td align="left" height="20" colspan=2>
                  <table cellspacing="1" border="0" bgcolor="#ffffff" width="100%">
                   <tr class="line-even">
                     ...
                     <td><textarea class="text-area" name="cw_fb" cols="60" rows="6" title="回复"></textarea></td>
                   </tr>
                  </table>
                </td>
            </tr>
