...
String sqlStr = "select c.cp_id,c.cp_name,c.dt_name from tb_connproc c,tb_deptinfo d where (c.cp_id='o4' or c.cp_upid='o4') and c.dt_id=d.dt_id and d.dt_id=" + selfdtid + "order by cp_name";
String cp_id = "";
String cp_name = "";
String dt_name = "监察委";
String strTitle = "投诉事项列表";
//update20080122
...
<!--    功能按钮开始    -->
<img src="../../../images/new.gif" border="0" onclick="window.location='ProceedingInfo.jsp?cp_id=<%=cp_id%>&dt_name=<%=dt_name%>'" title="新投诉处理" style="cursor:hand" align="absmiddle" WIDTH="16" HEIGHT="16">
新增
...
<form name="formData">
  <tr class="bttn" width="100%">
    <td align="center" width="10%">投诉处理事项ID</td>
    <td align="center" width="40%">投诉处理事项名称</td>
    <td align="center" width="30%">投诉受理单位</td>
