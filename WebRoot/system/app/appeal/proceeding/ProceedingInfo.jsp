...
String strTitle="新增投诉类型";
        cp_id=CTools.dealString(request.getParameter("cp_id"));
        dt_name=CTools.dealString(request.getParameter("dt_name"));
        if(!cp_id.equals(""))
        {
...
<form action="ProceedingInfoResult.jsp" method="post" name="formData">
      <tr class="line-even" >
        <td  colspan=2>请填写投诉处理事项资料：（注意带有<font color=red>*</font>的项目必须填写）</td>
                  </tr>
      <tr class="line-odd">
        
      <td height="18" align="right">投诉处理事项名称：</td>
      <td align="left"><input type="text" name="cp_name" value="<%=cp_name%>" class="text-line"> <font color=red>*</font></td>
      </tr>
      <tr class="line-odd">
        <td align="right">受理单位：</td><td align="left"><input type="text" name="dt_name" value="<%=dt_name%>" class="text-line" disabled=false></td>
      </tr>
      <tr class="line-odd">
        <td align="right">受理时限：</td><td align="left">
          <input type="text" name="deal_time" value="<%=deal_time%>" class="text-line" onKeyDown="floatOnly(value)" maxlength="7"> 天 <font color=red>*</font>
        </td>
      </tr>
      <tr class="line-odd">
        <td align="right">受理中时限：</td><td align="left">
      ...
      <tr class="line-odd">
        ...
        <td align="left">
        	<input type="text" name="corr_time" value="<%=corr_time%>" class="text-line" onKeyDown="floatOnly(value)" maxlength="7"> 天 <font color=red>*</font>
        </td>
      </tr>
