...
<%
 ...
 if (list_id == null || list_id.equals("")){
	 list_id = "0";
	 sql = "select * from tb_function where ft_name in ("+ moduleName +") order by ft_sequence";
 }else{
	 sql = "select * from tb_function where ft_parent_id = " + list_id + "  order by ft_sequence";
 }
//out.print(list_id);
