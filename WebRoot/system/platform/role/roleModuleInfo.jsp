    ...
    <tr>
      <td width="100%" align="left" colspan="2">
                <table width="100%" cellspacing="0">
                        <tr class="title1">
                                <td id="TitleTd" width="100%" align="left">当前角色：<%=session.getAttribute("_platform_tr_name").toString()%> 当前操作：权限</td>
...
<form name="formData" method="post" action="roleModuleInfoResult.jsp">
