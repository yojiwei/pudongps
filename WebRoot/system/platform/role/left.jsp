...
<%
 ...
 // CManager manage = (CManager)session.getAttribute("manager");
  ...
  String sql = "select * from tb_roleinfo　where tr_createby = '"+ loginname +"' order by tr_id";
  String sql = "select * from tb_roleinfo　 order by tr_id";
    ...
    <table border="0" cellpadding="0" id="dataBoard" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber3" height="54">
      <tr>
        ...
        %>
                        ...
                        <a href="roleList.jsp?tr_id=<%=content.get("tr_id")%>" target="main"><%=content.get("tr_name")%></a>
                        <br>
        <%
          }
        }
