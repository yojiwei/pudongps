...
// out.print(node_title);
 ...
 sql = " select dt_id as id,dt_name as name,1 as flag,dt_sequence as sequence from tb_deptinfo where dt_parent_id = "
 	   + list_id + " and dt_name in ("+ orgname + ") union select ui_id as id, ui_name as name,"
                  ...
                  <td width="100%" height="32">
					  ...
					  <table border="0" width="100%" cellpadding="3" height="44">
						<tr class="bttn">
						    ...
						    <td width="8%" height="1" class="outset-table">类型</td>
						    <td width="66%" height="1" class="outset-table">名称</td>
