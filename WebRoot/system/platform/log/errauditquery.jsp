...
<form name="errquery" action="errAuditResult.jsp" method="post">
<table border=0 cellspacing="1" cellpadding="0" width="100%">
<tr class="bttn"><td colspan="2">审计日志查询
</td></tr>

<tr class="line-odd"><td width="15%" align="right" >用&nbsp;&nbsp;&nbsp;&nbsp;户</td>
<td width="85%">&nbsp;&nbsp;<input class="text-line" name="user" type="text" size="21" maxlength="21"></td></tr>
<tr class="line-even"><td width="15%" align="right" >新闻标题</td>
<td width="85%">&nbsp;&nbsp;<input class="text-line" name="title" type="text" size="70" maxlength="70"></td></tr>
<tr class="line-odd"><td width="15%" align="right">审计时间</td>
<td width="85%">&nbsp; 
...
<tr class="line-even"><td width="15%" align="right">操作方式</td>
<td width="85%">&nbsp;&nbsp;<select class=select-a  name=opertype>
