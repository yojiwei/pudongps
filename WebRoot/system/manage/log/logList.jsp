...
<%
  String sql = "";
  String title = "";
  String lg_type = CTools.dealString(request.getParameter("type")).trim();

  if (lg_type.equals("1")) {
    title = "系统登录日志";
  }
else if (lg_type.equals("4")) {
	  title = "信息操作日志";
	}
 ...
 sql =    "select * from tb_log where lg_type = "+ lg_type +" order by lg_id desc";
 //out.print(sql);
  jdo.setSql(sql);
%>
					   ...
					   <table width="100%">
						 <tr>
							...
							<img src="/system/images/dialog/split.gif" align="middle" border="0">
								<img src="/system/images/dialog/delete.gif" border="0" onclick="del()" title="清除所有<%=title%>" style="cursor:hand" align="absmiddle" id="image2" name="image2" WIDTH="16" HEIGHT="16">
								<img src="/system/images/dialog/split.gif" align="middle" border="0">
